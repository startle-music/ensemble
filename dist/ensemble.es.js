...
function wi() {
  return dr || (dr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var H = !1, v = !1, ie = !1, de = !1, Ce = !1, le;
    le = Symbol.for("react.module.reference");
    function je(l) {
      return !!(typeof l == "string" || typeof l == "function" || l === r || l === i || Ce || l === a || l === d || l === f || de || l === k || H || v || ie || typeof l == "object" && l !== null && (l.$$typeof === g || l.$$typeof === m || l.$$typeof === o || l.$$typeof === s || l.$$typeof === c || // This needs to include all possible module reference object
      ...
      if (typeof l == "object")
        switch (l.$$typeof) {
          ...
          case m:
            ...
            return R !== null ? R : me(l.type) || "Memo";
          case g: {
    ...
    var fe = Object.assign, Se = 0, pe, ye, Fe, Ge, h, S, N;
    function M() {
    }
    ...
    function _() {
      {
        if (Se === 0) {
          pe = console.log, ye = console.info, Fe = console.warn, Ge = console.error, h = console.group, S = console.groupCollapsed, N = console.groupEnd;
          var l = {
            configurable: !0,
            enumerable: !0,
            value: M,
...
` + Y[te].replace(" at new ", " at ");
    ...
    function ai(l, b) {
      if (typeof l.ref == "string" && rt.current && b && rt.current.stateNode !== b) {
        var y = me(rt.current.type);
        Xt[y] || (I('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', me(rt.current.type), l.ref), Xt[y] = !0);
      }
    }
    function ii(l, b) {
      {
    ...
    function li(l, b, y, R, X) {
      {
        ...
        return si(l, Y, ce, X, R, rt.current, G);
      }
    }
    ...
    function or(l, b) {
      {
        ...
        ir[y] = !0;
        var R = "";
        l && l._owner && l._owner !== Zt.current && (R = " It was passed a child from " + me(l._owner.type) + "."), Xe(l), I('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', y, R), Xe(null);
      }
    }
    function sr(l, b) {
      {
    ...
    function lr(l, b, y, R, X, V) {
      {
        ...
        if (!G) {
          ...
          ce ? Y += ce : Y += ar();
          var te;
          l === null ? te = "null" : qt(l) ? te = "array" : l !== void 0 && l.$$typeof === t ? (te = "<" + (me(l.type) || "Unknown") + " />", Y = " Did you accidentally export a JSX literal instead of a component?") : te = typeof l, I("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", te, Y);
        }
        var ne = li(l, b, y, X, V);
        if (ne == null)
          return ne;
...
`, Si = p.div`
    ...
    transform: scale(1.2);
    animation: ${Ci} 3s;
`, jf = ({ src: e = null }) => /* @__PURE__ */ u(ki, { className: "background", children: /* @__PURE__ */ u(Si, { className: "background__inner", src: e }) }), $i = ae`
...
`, Ln = ae`
    ...
    ${({ action: e, outline: t }) => e === !0 ? Ei : t === !0 ? Ti : $i};
    ${({ inline: e }) => e === !0 ? Pi : ""};
...
class Ho extends hi {
  ...
  renderMore() {
    ...
    return /* @__PURE__ */ u(br, { children: /* @__PURE__ */ u(xe, { onClick: ((a) => {
      n(a);
...
const Ko = p.tr`
    ${qo}
`, Zf = ({ children: e, background: t = null, opacity: n = 1, stickyActions: r = !0, className: a = null, ...i }) => /* @__PURE__ */ u(Ko, { className: a, background: t, opacity: n, stickyActions: r, ...i, children: e }), Vo = p.th`
    ${ga}
    padding: 15px 15px;
`, Kf = ({ children: e, className: t }) => /* @__PURE__ */ u(Vo, { className: t, children: e }), Jo = p.td`
    ${ga}
    text-align: ${(e) => e.align ? e.align : null};
`, Vf = ({ children: e, align: t, className: n }) => /* @__PURE__ */ u(Jo, { className: n, align: t, children: e }), Qo = p.div`
    display:flex;
    width:100%;
    font-family: inherit;
...
`, eu = ({ children: e, columns: t = "12rem", ...n }) => /* @__PURE__ */ u(fs, { ...n, columnString: typeof t == "string" ? t : null, columnArray: typeof t != "string" ? t : null, children: e }), us = p.div`
    display: flex;
    flex-wrap: nowrap;
    border-bottom: 1px solid ${(e) => e.theme.main.color};
`, tu = ({ children: e }) => /* @__PURE__ */ u(us, { children: e }), ds = p.div`
    padding: 0.6rem 0.4rem;
`, nu = ({ children: e, ...t }) => /* @__PURE__ */ u(ds, { ...t, children: e }), hr = p.div`
    padding: 0.6rem 0.4rem;
`, ms = ae`
    //color: ${(e) => e.theme.main.color};
    //font-family: ${(e) => e.theme.main.font};
...
`, au = ({ children: e }) => /* @__PURE__ */ u(bs, { children: e }), gs = p.form`
    display: flex;
    flex-direction: column;
    width: 100%;
`, hs = p.div`
...
`, Ss = ({ children: e, inputColour: t }) => e === null ? null : /* @__PURE__ */ u(Cs, { inputColour: t, children: e }), su = ({
  ...
  let O = () => null;
  o !== null && (O = () => /* @__PURE__ */ u(Lt, { children: o }));
  let T = {
...
`, Os = ({ children: e }) => e ? /* @__PURE__ */ u($s, { children: e }) : null, Rs = ({ value: e, name: t, children: n, label: r, inline: a = !1, onChange: i = () => {
...
var Zs = Nn.navigator || {}, Cr = Zs.userAgent, Sr = Cr === void 0 ? "" : Cr, Ie = Nn, Q = xa, $r = wa, wt = ka;
Ie.document;
var Oe = !!Q.documentElement && !!Q.head && typeof Q.addEventListener == "function" && typeof Q.createElement == "function", Ca = ~Sr.indexOf("MSIE") || ~Sr.indexOf("Trident/"), kt, Ct, St, $t, Et, Ee = "___FONT_AWESOME___", yn = 16, Sa = "fa", $a = "svg-inline--fa", Be = "data-fa-i2svg", xn = "data-fa-pseudo-element", Ks = "data-fa-pseudo-element-pending", Dn = "data-prefix", zn = "data-icon", Er = "fontawesome-i2svg", Vs = "async", Js = ["HTML", "HEAD", "STYLE", "SCRIPT"], Ea = function() {
  try {
...
var ut = ht((kt = {}, re(kt, J, {
  ...
  "fa-light": "fasl",
  "fa-thin": "fast"
}), $t)), el = /fa(s|r|l|t|d|b|k|ss|sr|sl|st)?[\-\ ]/, Pa = "fa-layers-text", tl = /Font ?Awesome ?([56 ]*)(Solid|Regular|Light|Thin|Duotone|Brands|Free|Pro|Sharp|Kit)?.*/i, nl = ht((Et = {}, re(Et, J, {
  900: "fas",
  400: "far",
  normal: "far",
  300: "fal",
...
function Aa() {
  var e = Sa, t = $a, n = $.cssPrefix, r = $.replacementClass, a = bl;
  if (n !== e || r !== t) {
...
var Na = function() {
  ...
  ja = r.names, Fa = r.unicodes, Hn = Yt($.styleDefault, {
...
function Ht(e) {
  ...
  var c = e.reduce(function(d, f) {
    var m = El($.cssPrefix, f);
    if (Ke[f] ? (f = Cl[s].includes(f) ? Qs[s][f] : f, o = f, d.prefix = f) : Sl[s].indexOf(f) > -1 ? (o = f, d.prefix = Yt(f, {
      family: s
...
function qn(e) {
  var t = e.icons, n = t.main, r = t.mask, a = e.prefix, i = e.iconName, o = e.transform, s = e.symbol, c = e.title, d = e.maskId, f = e.titleId, m = e.extra, g = e.watchable, k = g === void 0 ? !1 : g, E = r.found ? r : n, P = E.width, O = E.height, T = a === "fak", I = [$.replacementClass, i ? "".concat($.cssPrefix, "-").concat(i) : ""].filter(function(le) {
  ...
  var v = C(C({}, F), {}, {
    ...
    children: [],
    attributes: {}
  }, de = ie.children, Ce = ie.attributes;
  return v.children = de, v.attributes = Ce, s ? Ml(v) : Fl(v);
}
function Ir(e) {
...
function zl(e, t) {
  !Ea && !$.showMissingIcons && e && console.error('Icon with name "'.concat(e, '" and prefix "').concat(t, '" is missing.'));
}
function En(e, t) {
  var n = t;
...
function Ua(e) {
  ...
  return ~t.extra.classes.indexOf(Pa) ? Te("generateLayersText", e, t) : Te("generateSvgReplacementMutation", e, t);
}
...
var nc = function(t) {
  var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, r = n.transform, a = r === void 0 ? ke : r, i = n.symbol, o = i === void 0 ? !1 : i, s = n.mask, c = s === void 0 ? null : s, d = n.maskId, f = d === void 0 ? null : d, m = n.title, g = m === void 0 ? null : m, k = n.titleId, E = k === void 0 ? null : k, P = n.classes, O = P === void 0 ? [] : P, T = n.attributes, I = T === void 0 ? {} : T, F = n.styles, H = F === void 0 ? {} : F;
  if (t) {
    var v = t.prefix, ie = t.iconName, de = t.icon;
    return Ut(C({
      type: "icon"
    }, t), function() {
  ...
  mixout: function() {
    return {
      text: function(n) {
        var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, a = r.transform, i = a === void 0 ? ke : a, o = r.title, s = o === void 0 ? null : o, c = r.classes, d = c === void 0 ? [] : c, f = r.attributes, m = f === void 0 ? {} : f, g = r.styles, k = g === void 0 ? {} : g;
        return Ut({
          type: "text",
          content: n
        }, function() {
...
function zr(e, t) {
  ...
  return new Promise(function(r, a) {
    if (e.getAttribute(n) !== null)
      return r();
    var i = nt(e.children), o = i.filter(function(de) {
      return de.getAttribute(xn) === t;
    ...
    if (c && f !== "none" && f !== "") {
      ...
      if (I && !O && (!o || o.getAttribute(Dn) !== k || o.getAttribute(zn) !== F)) {
        ...
        var v = Jl(), ie = v.extra;
        ie.attributes[xn] = t, En(I, k).then(function(de) {
          var Ce = qn(C(C({}, v), {}, {
            icons: {
              main: de,
              mask: Gn()
...
function xc() {
  ...
  return Z.AsyncMode = c, Z.ConcurrentMode = d, Z.ContextConsumer = s, Z.ContextProvider = o, Z.Element = t, Z.ForwardRef = f, Z.Fragment = r, Z.Lazy = E, Z.Memo = k, Z.Portal = n, Z.Profiler = i, Z.StrictMode = a, Z.Suspense = m, Z.isAsyncMode = function(v) {
    ...
    return typeof v == "string" || typeof v == "function" || v === r || v === d || v === i || v === a || v === m || v === g || typeof v == "object" && v !== null && (v.$$typeof === E || v.$$typeof === k || v.$$typeof === o || v.$$typeof === s || v.$$typeof === f || v.$$typeof === O || v.$$typeof === T || v.$$typeof === I || v.$$typeof === P);
  }, Z.typeOf = F, Z;
}
var K = {};
/** @license React v16.13.1
...
function wc() {
  return Gr || (Gr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function F(w) {
      ...
      w === r || w === d || w === i || w === a || w === m || w === g || typeof w == "object" && w !== null && (w.$$typeof === E || w.$$typeof === k || w.$$typeof === o || w.$$typeof === s || w.$$typeof === f || w.$$typeof === O || w.$$typeof === T || w.$$typeof === I || w.$$typeof === P);
    }
    function H(w) {
    ...
    var v = c, ie = d, de = s, Ce = o, le = t, je = f, He = r, Ue = E, me = k, fe = n, Se = i, pe = a, ye = m, Fe = !1;
    function Ge(w) {
    ...
    K.AsyncMode = v, K.ConcurrentMode = ie, K.ContextConsumer = de, K.ContextProvider = Ce, K.Element = le, K.ForwardRef = je, K.Fragment = He, K.Lazy = Ue, K.Memo = me, K.Portal = fe, K.Profiler = Se, K.StrictMode = pe, K.Suspense = ye, K.isAsyncMode = Ge, K.isConcurrentMode = h, K.isContextConsumer = S, K.isContextProvider = N, K.isElement = M, K.isForwardRef = _, K.isFragment = U, K.isLazy = L, K.isMemo = j, K.isPortal = D, K.isProfiler = q, K.isStrictMode = z, K.isSuspense = se, K.isValidElementType = F, K.typeOf = H;
  }()), K;
}
var qr;
function Ga() {
...
function jc(e) {
  var t, n = e.beat, r = e.fade, a = e.beatFade, i = e.bounce, o = e.shake, s = e.flash, c = e.spin, d = e.spinPulse, f = e.spinReverse, m = e.pulse, g = e.fixedWidth, k = e.inverse, E = e.border, P = e.listItem, O = e.flip, T = e.size, I = e.rotation, F = e.pull, H = (t = {
    "fa-beat": n,
    "fa-fade": r,
    "fa-beat-fade": a,
    "fa-bounce": i,
...
`, Jc = (e) => ({ altColour: "white", primaryColour: "red" }), du = ({ name: e, id: t, checked: n, value: r, label: a, colour: i = "simplyRed", className: o = null, ...s }) => {
  const c = { ...s, ...Jc() };
  return console.log("switch attributes", c), /* @__PURE__ */ u(Zc, { className: o, ...c, children: /* @__PURE__ */ W(Kc, { htmlFor: e, ...c, children: [
...
`, pu = ({ id: e, checked: t = !1, children: n, ...r }) => /* @__PURE__ */ u(of, { id: e, className: t ? "active" : "", ...r, children: n }, `tab-${e}`), na = p.div`
    display: block;
    position: relative;
`, bu = ({
  children: e,
...
`, gu = ({
  ...
  children: t,
  ...n
}) => /* @__PURE__ */ u(sf, { className: e ? "active" : "", ...n, children: t }), lf = p.div`
...
`, hu = ({
  children: e,
  ...t
}) => /* @__PURE__ */ u(lf, { ...t, children: /* @__PURE__ */ u(cf, { children: e }) }), ff = p.div`
    display: block;
    position: relative;
`, vu = ({
  children: e,
  ...t
}) => /* @__PURE__ */ u(ff, { ...t, children: e }), uf = p.div`
    display: flex;
    justify-content: space-around;
    align-items: center;
    flex-direction: column;
    border: 1px solid ${ue.form.input.border};
    width: 100%;
    aspect-ratio: 16/9;
    padding: 2rem;
`, df = p(Ye)`
...
function pf({ icon: e, title: t = "", component: n = null, className: r }) {
  return /* @__PURE__ */ W(uf, { className: r, children: [
    /* @__PURE__ */ u(df, { icon: e, color: ue.form.input.border }),
...
function yu({ icon: e, title: t = "", component: n = null }) {
  return /* @__PURE__ */ u(bf, { icon: e, title: t, component: n });
}
const gf = p.div`
...
function Su({
  ...
  return oa(() => (n(), () => {
    ...
    /* @__PURE__ */ u(yf, { id: "mainModal", transparent: a, children: e })
  ] }) : null;
}
const xf = p.ul`
    overflow-y: auto;
...
function kf({ padding: e = null, margin: t, children: n }) {
  return /* @__PURE__ */ u(xf, { padding: e, margin: t, children: n });
}
const Cf = p.div`
    padding: 1rem;
...
function Au({ children: e }) {
  ...
  return /* @__PURE__ */ u(Sf, { children: a });
}
const $f = p.circle`
    fill: none;
  ...
  return t < 0 ? o = 0 : t > oe.Children.count(e) - 1 && (o = oe.Children.count(e) - 1), /* @__PURE__ */ W(Of, { children: [
    /* @__PURE__ */ W(Rf, { children: [
      ...
      /* @__PURE__ */ W(If, { children: [
        ...
        oe.Children.map(e, (s, c) => c === o ? /* @__PURE__ */ u(rf, { margin: "0px", children: s.props.title }) : null)
      ] })
    ] }),
    oe.Children.map(e, (s, c) => c === o ? s : null),
    /* @__PURE__ */ W(Af, { children: [
      /* @__PURE__ */ u(xe, { onClick: r, disabled: o === 0, children: "Previous" }),
      // if last step show submit button
      o === oe.Children.count(e) - 1 ? /* @__PURE__ */ u(xe, { onClick: a, children: i }) : /* @__PURE__ */ u(xe, { onClick: n, disabled: o === oe.Children.count(e) - 1, children: "Next Step" })
    ] })
  ] });
}
export {
