...
`,Ya=m(Wa)``,uf=m.div`
    margin: 0 0.5rem;
    color: ${({theme:e})=>e.main.color};
`;function df({label:e,name:t,hourMin:n=0,hourMax:r=23,hourValue:a,minuteMin:i=0,minuteMax:o=59,minuteValue:s,onChange:c}){const[u,f]=I.useState(a),[p,h]=I.useState(s);I.useEffect(()=>{f(a),h(s)},[a,s]);function g(){const $=[];for(let E=n;E<=r;E++)$.push(E<10?`0${E}`:E);return $}function P(){const $=[];for(let E=i;E<=o;E++)$.push(E<10?`0${E}`:E);return $}return z(cf,{children:[d(Wt,{children:e}),z(ff,{children:[d(Ya,{value:u,name:`${t}[hour]`,inline:!0,onChange:$=>{c($),f($.target.value)},children:g().map($=>d("option",{value:$,children:$},`${t}-${$}`))},`${t}-hour`),d(uf,{children:":"}),d(Ya,{value:p,name:`${t}[minute]`,inline:!0,onChange:$=>{c($),h($.target.value)},children:P().map($=>d("option",{value:$,children:$},`${t}-${$}`))},`${t}-minute`)]})]})}const mf=m.textarea`
    width: 100%;
    height: 10rem;
    padding: 0.5rem;
    margin: 0 0 1rem;
