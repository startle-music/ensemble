 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var or;function ci(){return or||(or=1,process.env.NODE_ENV!=="production"&&function(){var e=A,t=Symbol.for("react.element"),n=Symbol.for("react.portal"),r=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),i=Symbol.for("react.profiler"),o=Symbol.for("react.provider"),s=Symbol.for("react.context"),c=Symbol.for("react.forward_ref"),u=Symbol.for("react.suspense"),f=Symbol.for("react.suspense_list"),p=Symbol.for("react.memo"),h=Symbol.for("react.lazy"),w=Symbol.for("react.offscreen"),E=Symbol.iterator,T="@@iterator";function I(l){if(l===null||typeof l!="object")return null;var b=E&&l[E]||l[T];return typeof b=="function"?b:null}var L=e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;function R(l){{for(var b=arguments.length,k=new Array(b>1?b-1:0),_=1;_<b;_++)k[_-1]=arguments[_];F("error",l,k)}}function F(l,b,k){{var _=L.ReactDebugCurrentFrame,K=_.getStackAddendum();K!==""&&(b+="%s",k=k.concat([K]));var te=k.map(function(V){return String(V)});te.unshift("Warning: "+b),Function.prototype.apply.call(console[l],console,te)}}var U=!1,v=!1,de=!1,be=!1,xe=!1,ce;ce=Symbol.for("react.module.reference");function Re(l){return!!(typeof l=="string"||typeof l=="function"||l===r||l===i||xe||l===a||l===u||l===f||be||l===w||U||v||de||typeof l=="object"&&l!==null&&(l.$$typeof===h||l.$$typeof===p||l.$$typeof===o||l.$$typeof===s||l.$$typeof===c||l.$$typeof===ce||l.getModuleId!==void 0))}function Ne(l,b,k){var _=l.displayName;if(_)return _;var K=b.displayName||b.name||"";return K!==""?k+"("+K+")":k}function _e(l){return l.displayName||"Context"}function B(l){if(l==null)return null;if(typeof l.tag=="number"&&R("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."),typeof l=="function")return l.displayName||l.name||null;if(typeof l=="string")return l;switch(l){case r:return"Fragment";case n:return"Portal";case i:return"Profiler";case a:return"StrictMode";case u:return"Suspense";case f:return"SuspenseList"}if(typeof l=="object")switch(l.$$typeof){case s:var b=l;return _e(b)+".Consumer";case o:var k=l;return _e(k._context)+".Provider";case c:return Ne(l,l.render,"ForwardRef");case p:var _=l.displayName||null;return _!==null?_:B(l.type)||"Memo";case h:{var K=l,te=K._payload,V=K._init;try{return B(V(te))}catch{return null}}}return null}var ee=Object.assign,ie=0,ne,se,pe,me,g,S,W;function N(){}N.__reactDisabledLog=!0;function j(){{if(ie===0){ne=console.log,se=console.info,pe=console.warn,me=console.error,g=console.group,S=console.groupCollapsed,W=console.groupEnd;var l={configurable:!0,enumerable:!0,value:N,writable:!0};Object.defineProperties(console,{info:l,log:l,warn:l,error:l,group:l,groupCollapsed:l,groupEnd:l})}ie++}}function X(){{if(ie--,ie===0){var l={configurable:!0,enumerable:!0,writable:!0};Object.defineProperties(console,{log:ee({},l,{value:ne}),info:ee({},l,{value:se}),warn:ee({},l,{value:pe}),error:ee({},l,{value:me}),group:ee({},l,{value:g}),groupCollapsed:ee({},l,{value:S}),groupEnd:ee({},l,{value:W})})}ie<0&&R("disabledDepth fell below zero. This is a bug in React. Please file an issue.")}}var M=L.ReactCurrentDispatcher,D;function H(l,b,k){{if(D===void 0)try{throw Error()}catch(K){var _=K.stack.trim().match(/\n( *(at )?)/);D=_&&_[1]||""}return`
`+D+l}}var Z=!1,G;{var he=typeof WeakMap=="function"?WeakMap:Map;G=new he}function $(l,b){if(!l||Z)return"";{var k=G.get(l);if(k!==void 0)return k}var _;Z=!0;var K=Error.prepareStackTrace;Error.prepareStackTrace=void 0;var te;te=M.current,M.current=null,j();try{if(b){var V=function(){throw Error()};if(Object.defineProperty(V.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(V,[])}catch(Le){_=Le}Reflect.construct(l,[],V)}else{try{V.call()}catch(Le){_=Le}l.call(V.prototype)}}else{try{throw Error()}catch(Le){_=Le}l()}}catch(Le){if(Le&&_&&typeof Le.stack=="string"){for(var q=Le.stack.split(`
`),ge=_.stack.split(`
`),le=q.length-1,fe=ge.length-1;le>=1&&fe>=0&&q[le]!==ge[fe];)fe--;for(;le>=1&&fe>=0;le--,fe--)if(q[le]!==ge[fe]){if(le!==1||fe!==1)do if(le--,fe--,fe<0||q[le]!==ge[fe]){var $e=`
`+q[le].replace(" at new "," at ");return l.displayName&&$e.includes("<anonymous>")&&($e=$e.replace("<anonymous>",l.displayName)),typeof l=="function"&&G.set(l,$e),$e}while(le>=1&&fe>=0);break}}}finally{Z=!1,M.current=te,X(),Error.prepareStackTrace=K}var nt=l?l.displayName||l.name:"",oi=nt?H(nt):"";return typeof l=="function"&&G.set(l,oi),oi}function ke(l,b,k){return $(l,!1)}function et(l){var b=l.prototype;return!!(b&&b.isReactComponent)}function Ue(l,b,k){if(l==null)return"";if(typeof l=="function")return $(l,et(l));if(typeof l=="string")return H(l);switch(l){case u:return H("Suspense");case f:return H("SuspenseList")}if(typeof l=="object")switch(l.$$typeof){case c:return ke(l.render);case p:return Ue(l.type,b,k);case h:{var _=l,K=_._payload,te=_._init;try{return Ue(te(K),b,k)}catch{}}}return""}var Ut=Object.prototype.hasOwnProperty,Xa={},Va=L.ReactDebugCurrentFrame;function qt(l){if(l){var b=l._owner,k=Ue(l.type,l._source,b?b.type:null);Va.setExtraStackFrame(k)}else Va.setExtraStackFrame(null)}function ju(l,b,k,_,K){{var te=Function.call.bind(Ut);for(var V in l)if(te(l,V)){var q=void 0;try{if(typeof l[V]!="function"){var ge=Error((_||"React class")+": "+k+" type `"+V+"` is invalid; it must be a function, usually from the `prop-types` package, but received `"+typeof l[V]+"`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");throw ge.name="Invariant Violation",ge}q=l[V](b,V,_,k,null,"SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED")}catch(le){q=le}q&&!(q instanceof Error)&&(qt(K),R("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).",_||"React class",k,V,typeof q),qt(null)),q instanceof Error&&!(q.message in Xa)&&(Xa[q.message]=!0,qt(K),R("Failed %s type: %s",k,q.message),qt(null))}}}var Fu=Array.isArray;function er(l){return Fu(l)}function Mu(l){{var b=typeof Symbol=="function"&&Symbol.toStringTag,k=b&&l[Symbol.toStringTag]||l.constructor.name||"Object";return k}}function zu(l){try{return Za(l),!1}catch{return!0}}function Za(l){return""+l}function Ka(l){if(zu(l))return R("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.",Mu(l)),Za(l)}var vt=L.ReactCurrentOwner,Du={key:!0,ref:!0,__self:!0,__source:!0},Ja,Qa,tr;tr={};function Nu(l){if(Ut.call(l,"ref")){var b=Object.getOwnPropertyDescriptor(l,"ref").get;if(b&&b.isReactWarning)return!1}return l.ref!==void 0}function Bu(l){if(Ut.call(l,"key")){var b=Object.getOwnPropertyDescriptor(l,"key").get;if(b&&b.isReactWarning)return!1}return l.key!==void 0}function Wu(l,b){if(typeof l.ref=="string"&&vt.current&&b&&vt.current.stateNode!==b){var k=B(vt.current.type);tr[k]||(R('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref',B(vt.current.type),l.ref),tr[k]=!0)}}function Yu(l,b){{var k=function(){Ja||(Ja=!0,R("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",b))};k.isReactWarning=!0,Object.defineProperty(l,"key",{get:k,configurable:!0})}}function Hu(l,b){{var k=function(){Qa||(Qa=!0,R("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",b))};k.isReactWarning=!0,Object.defineProperty(l,"ref",{get:k,configurable:!0})}}var Gu=function(l,b,k,_,K,te,V){var q={$$typeof:t,type:l,key:b,ref:k,props:V,_owner:te};return q._store={},Object.defineProperty(q._store,"validated",{configurable:!1,enumerable:!1,writable:!0,value:!1}),Object.defineProperty(q,"_self",{configurable:!1,enumerable:!1,writable:!1,value:_}),Object.defineProperty(q,"_source",{configurable:!1,enumerable:!1,writable:!1,value:K}),Object.freeze&&(Object.freeze(q.props),Object.freeze(q)),q};function Uu(l,b,k,_,K){{var te,V={},q=null,ge=null;k!==void 0&&(Ka(k),q=""+k),Bu(b)&&(Ka(b.key),q=""+b.key),Nu(b)&&(ge=b.ref,Wu(b,K));for(te in b)Ut.call(b,te)&&!Du.hasOwnProperty(te)&&(V[te]=b[te]);if(l&&l.defaultProps){var le=l.defaultProps;for(te in le)V[te]===void 0&&(V[te]=le[te])}if(q||ge){var fe=typeof l=="function"?l.displayName||l.name||"Unknown":l;q&&Yu(V,fe),ge&&Hu(V,fe)}return Gu(l,q,ge,K,_,vt.current,V)}}var nr=L.ReactCurrentOwner,ei=L.ReactDebugCurrentFrame;function tt(l){if(l){var b=l._owner,k=Ue(l.type,l._source,b?b.type:null);ei.setExtraStackFrame(k)}else ei.setExtraStackFrame(null)}var rr;rr=!1;function ar(l){return typeof l=="object"&&l!==null&&l.$$typeof===t}function ti(){{if(nr.current){var l=B(nr.current.type);if(l)return`
...
Check the top-level render call using <`+k+">.")}return b}}function ri(l,b){{if(!l._store||l._store.validated||l.key!=null)return;l._store.validated=!0;var k=Xu(b);if(ni[k])return;ni[k]=!0;var _="";l&&l._owner&&l._owner!==nr.current&&(_=" It was passed a child from "+B(l._owner.type)+"."),tt(l),R('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.',k,_),tt(null)}}function ai(l,b){{if(typeof l!="object")return;if(er(l))for(var k=0;k<l.length;k++){var _=l[k];ar(_)&&ri(_,b)}else if(ar(l))l._store&&(l._store.validated=!0);else if(l){var K=I(l);if(typeof K=="function"&&K!==l.entries)for(var te=K.call(l),V;!(V=te.next()).done;)ar(V.value)&&ri(V.value,b)}}}function Vu(l){{var b=l.type;if(b==null||typeof b=="string")return;var k;if(typeof b=="function")k=b.propTypes;else if(typeof b=="object"&&(b.$$typeof===c||b.$$typeof===p))k=b.propTypes;else return;if(k){var _=B(b);ju(k,l.props,"prop",_,l)}else if(b.PropTypes!==void 0&&!rr){rr=!0;var K=B(b);R("Component %s declared `PropTypes` instead of `propTypes`. Did you misspell the property assignment?",K||"Unknown")}typeof b.getDefaultProps=="function"&&!b.getDefaultProps.isReactClassApproved&&R("getDefaultProps is only used on classic React.createClass definitions. Use a static property named `defaultProps` instead.")}}function Zu(l){{for(var b=Object.keys(l.props),k=0;k<b.length;k++){var _=b[k];if(_!=="children"&&_!=="key"){tt(l),R("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.",_),tt(null);break}}l.ref!==null&&(tt(l),R("Invalid attribute `ref` supplied to `React.Fragment`."),tt(null))}}function ii(l,b,k,_,K,te){{var V=Re(l);if(!V){var q="";(l===void 0||typeof l=="object"&&l!==null&&Object.keys(l).length===0)&&(q+=" You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports.");var ge=qu(K);ge?q+=ge:q+=ti();var le;l===null?le="null":er(l)?le="array":l!==void 0&&l.$$typeof===t?(le="<"+(B(l.type)||"Unknown")+" />",q=" Did you accidentally export a JSX literal instead of a component?"):le=typeof l,R("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s",le,q)}var fe=Uu(l,b,k,K,te);if(fe==null)return fe;if(V){var $e=b.children;if($e!==void 0)if(_)if(er($e)){for(var nt=0;nt<$e.length;nt++)ai($e[nt],l);Object.freeze&&Object.freeze($e)}else R("React.jsx: Static children should always be an array. You are likely explicitly calling React.jsxs or React.jsxDEV. Use the Babel transform instead.");else ai($e,l)}return l===r?Zu(fe):Vu(fe),fe}}function Ku(l,b,k){return ii(l,b,k,!0)}function Ju(l,b,k){return ii(l,b,k,!1)}var Qu=Ju,ed=Ku;at.Fragment=r,at.jsx=Qu,at.jsxs=ed}()),at}process.env.NODE_ENV==="production"?Xt.exports=li():Xt.exports=ci();var Vt=Xt.exports;const Zt=Vt.Fragment,d=Vt.jsx,z=Vt.jsxs,fi=m.circle`
    fill: none;
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var wa;function pl(){if(wa)return J;wa=1;var e=typeof Symbol=="function"&&Symbol.for,t=e?Symbol.for("react.element"):60103,n=e?Symbol.for("react.portal"):60106,r=e?Symbol.for("react.fragment"):60107,a=e?Symbol.for("react.strict_mode"):60108,i=e?Symbol.for("react.profiler"):60114,o=e?Symbol.for("react.provider"):60109,s=e?Symbol.for("react.context"):60110,c=e?Symbol.for("react.async_mode"):60111,u=e?Symbol.for("react.concurrent_mode"):60111,f=e?Symbol.for("react.forward_ref"):60112,p=e?Symbol.for("react.suspense"):60113,h=e?Symbol.for("react.suspense_list"):60120,w=e?Symbol.for("react.memo"):60115,E=e?Symbol.for("react.lazy"):60116,T=e?Symbol.for("react.block"):60121,I=e?Symbol.for("react.fundamental"):60117,L=e?Symbol.for("react.responder"):60118,R=e?Symbol.for("react.scope"):60119;function F(v){if(typeof v=="object"&&v!==null){var de=v.$$typeof;switch(de){case t:switch(v=v.type,v){case c:case u:case r:case i:case a:case p:return v;default:switch(v=v&&v.$$typeof,v){case s:case f:case E:case w:case o:return v;default:return de}}case n:return de}}}function U(v){return F(v)===u}return J.AsyncMode=c,J.ConcurrentMode=u,J.ContextConsumer=s,J.ContextProvider=o,J.Element=t,J.ForwardRef=f,J.Fragment=r,J.Lazy=E,J.Memo=w,J.Portal=n,J.Profiler=i,J.StrictMode=a,J.Suspense=p,J.isAsyncMode=function(v){return U(v)||F(v)===c},J.isConcurrentMode=U,J.isContextConsumer=function(v){return F(v)===s},J.isContextProvider=function(v){return F(v)===o},J.isElement=function(v){return typeof v=="object"&&v!==null&&v.$$typeof===t},J.isForwardRef=function(v){return F(v)===f},J.isFragment=function(v){return F(v)===r},J.isLazy=function(v){return F(v)===E},J.isMemo=function(v){return F(v)===w},J.isPortal=function(v){return F(v)===n},J.isProfiler=function(v){return F(v)===i},J.isStrictMode=function(v){return F(v)===a},J.isSuspense=function(v){return F(v)===p},J.isValidElementType=function(v){return typeof v=="string"||typeof v=="function"||v===r||v===u||v===i||v===a||v===p||v===h||typeof v=="object"&&v!==null&&(v.$$typeof===E||v.$$typeof===w||v.$$typeof===o||v.$$typeof===s||v.$$typeof===f||v.$$typeof===I||v.$$typeof===L||v.$$typeof===R||v.$$typeof===T)},J.typeOf=F,J}var Q={};/** @license React v16.13.1
...
`,bu=m.div`
    ...
    left: 0;
    width: 100%;
`;function qa({padding:e=null,margin:t,children:n,background:r,itemHeight:a=null,overscan:i=5,virtualized:o=!0}){const s=A.useRef(null),c=A.useRef(null),u=A.useRef({}),[f,p]=A.useState(0),[h,w]=A.useState(0),[E,T]=A.useState(a||40),[I,L]=A.useState([]),[R,F]=A.useState([]),[U,v]=A.useState(0),[de,be]=A.useState({width:window.innerWidth,height:window.innerHeight});A.useEffect(()=>{if(o&&s.current){const B=()=>{w(s.current.clientHeight),be({width:window.innerWidth,height:window.innerHeight})};return B(),window.addEventListener("resize",B),()=>{window.removeEventListener("resize",B)}}},[o]);const xe=A.useCallback(B=>{const ee=[];let ie=0;B.forEach(ne=>{ee.push(ie),ie+=ne}),F(ee),v(ie)},[]),ce=A.useCallback(()=>{if(!o||!n)return;const B=A.Children.toArray(n);if(B.length===0)return;if(a){const ne=Array(B.length).fill(a);L(ne),xe(ne);return}const ee=[];let ie=!0;if(B.forEach((ne,se)=>{const pe=u.current[se];pe?ee[se]=pe.getBoundingClientRect().height:(ee[se]=E,ie=!1)}),L(ee),xe(ee),!ie&&c.current){const ne=c.current.getBoundingClientRect().height;ne>0&&T(ne)}},[n,a,o,xe,E]);A.useEffect(()=>{if(!o||!n)return;const B=setTimeout(ce,50);return()=>clearTimeout(B)},[n,ce,o]),A.useEffect(()=>{if(!a){const B=setTimeout(ce,100);return()=>clearTimeout(B)}},[de,a,ce]);const Re=A.useCallback(()=>{if(R.length===0)return{startIndex:0,endIndex:0};let B=0,ee=R.length-1;for(;B<=ee;){const me=Math.floor((B+ee)/2);if(R[me]<=f){if(me===R.length-1||R[me+1]>f){B=me;break}B=me+1}else ee=me-1}let ie=B;const ne=f+h;for(;ie<R.length-1&&R[ie+1]<ne;)ie++;const se=Math.max(0,B-i),pe=Math.min(R.length-1,ie+i);return{startIndex:se,endIndex:pe}},[R,f,h,i]),Ne=B=>{o&&p(B.target.scrollTop)};let _e=n;if(o&&A.Children.count(n)>0){const B=A.Children.toArray(n),{startIndex:ee,endIndex:ie}=Re(),ne=B.slice(ee,ie+1);_e=z(Zt,{children:[d(bu,{ref:c,children:A.Children.map(n,(se,pe)=>d("div",{ref:me=>{u.current[pe]=me},children:A.cloneElement(se,{style:{position:"static",visibility:"hidden"}})},`measure-${pe}`))}),d(hu,{style:{height:U+"px"},children:ne.map((se,pe)=>{const me=ee+pe;return A.cloneElement(se,{key:`item-${me}`,style:{position:"absolute",top:R[me]+"px",width:"100%",...se.props.style||{}}})})})]})}return d(pu,{ref:s,padding:e,margin:t,background:r,onScroll:Ne,children:_e})}const gu=m.div`
    padding: 1rem;
