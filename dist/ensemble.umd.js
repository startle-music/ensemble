...
`,ts=m.div`
    ...
    margin-right:.5rem;
    color: ${e=>e.fill};
`,rs=({fill:e,leftText:n="",rightText:t="",Icon:r})=>z(ns,{children:[u(ts,{fill:e,children:u(r,{fill:e})}),u(xr,{fill:e,leftText:n,rightText:t})]}),ot=m.css`
...
`;function Cs({inline:e=!1,display:n=!1,nested:t,children:r}){return u(ks,{inline:e,nested:t,display:n,children:r})}function Ss({children:e,submitButton:n,onSubmit:t,forwardRef:r=null,...a}){return z(ws,{ref:r,onSubmit:t,...a,children:[e,n]})}const $s=m.label`
    display: block;
    font-size: 1.2rem;
    font-family: ${e=>e.theme.main.font};
...
`,Ts=m.span`
    display: inline-block;
    margin-left: 0.3rem;
`,Sn=({children:e,required:n=!1})=>{let t=()=>null;return n&&(t=u(Ts,{children:"*"})),z($s,{children:[e,u(t,{})]})},Es=m.css`
    //margin-bottom:5px;
    //font-size: 0.9rem;
...
`,Rs=m.p`
    ...
    font-size: 0.75rem;
    margin: 0.6rem 0;
`,As=({children:e,inputColour:n})=>e===null?null:u(Rs,{inputColour:n,children:e}),Is=({id:e,name:n,inputBackground:t=null,inputColour:r=null,inputBorder:a=null,prepend:i=null,append:o=null,label:s=null,type:c="text",caption:d=null,required:f=!1,placeholder:p=!1,defaultValue:g=null,status:S=null,...E})=>{let P=()=>null;i!==null&&(P=()=>u(xn,{children:i}));let A=()=>null;o!==null&&(A=()=>u(xn,{children:o}));let O={inputBackground:"white",inputColour:"black",inputBorder:xe.main.border};return t!==null&&(O={...O,inputBackground:t}),r!==null&&(O={...O,inputColour:r}),a!==null&&(O={...O,inputBorder:a}),z($n,{htmlFor:n,block:!0,children:[s!==null?u(Sn,{required:f,children:s}):null,z(Ps,{...E,...O,children:[u(P,{}),u(Os,{type:c,name:n,required:f,placeholder:p,defaultValue:g,id:e,...O,...E}),u(A,{})]}),u(As,{...O,children:d})]})},_s=m.div`
    display: flex;
    flex-direction: column;
    width: 100%;
`,Ls=m.select`
...
`,kr=({value:e,name:n,children:t,label:r,inline:a=!1,onChange:i=()=>{}})=>z(_s,{children:[r?u(Sn,{htmlFor:n,children:r}):null,u(js,{inline:a,children:u(Ls,{value:e,name:n,onChange:i,inline:!0,children:t})})]}),Fs=m.div`
    flex-direction: row;
...
`,st=({name:e,id:n,label:t=null,required:r,checked:a,value:i,inline:o=!1,disabled:s=!1,className:c=null,backgroundColor:d=null,color:f=null,margin:p=null,...g})=>u(Fs,{inline:o,className:c,margin:p,children:z(Ms,{htmlFor:n,disabled:s,children:[u(Ds,{type:"checkbox",name:e,id:n,required:r,value:i,checked:a,disabled:s,backgroundColor:d,color:f,...g}),t]})}),Ns=m.div`
    flex-direction: row;
    display: ${e=>e.inline?"inline-flex":"flex"};
    margin: ${e=>e.margin?e.margin:"0 2rem 0.8rem 0"};
    align-items: center;
...
`,Ws=({name:e,label:n="",required:t,checked:r,inline:a=!1,disabled:i=!1,value:o,margin:s=null,backgroundColor:c=null,color:d=null,className:f="",defaultChecked:p=!1,id:g=!1,...S})=>u(Ns,{inline:a,className:f,margin:s,children:z(zs,{htmlFor:g,disabled:i,children:[u(Bs,{type:"radio",checked:r,disabled:i,value:o,name:e,id:g||e,required:t,defaultChecked:r,backgroundColor:c,color:d,margin:n!=="",...S}),n]})}),Ys=m.div`
    width: 100%;
`,Hs=m.div`
    display: flex;
    flex-direction: row;
...
`,df=m.h4`
    ${Un}
    font-size: 1.2rem;
`,Da=({type:e="heading",children:n,...t})=>{switch(e.toLowerCase()){case"hero":return u(cf,{...t,children:n});case"title":return u(ff,{...t,children:n});case"subtitle":return u(uf,{...t,children:n});default:return u(df,{...t,children:n})}},mf=m.hr`
    width: ${({width:e})=>e};
    margin: 0 auto;
...
`;function za({icon:e,title:n="",component:t=null,className:r,collapse:a}){return z($f,{className:r,collapse:a,children:[u(Tf,{icon:e,color:xe.form.input.border}),u(Ef,{type:"heading",collapse:a,children:n}),t]})}const Pf=m(za)`
...
`;function Of({icon:e,title:n="",component:t=null,dropHandler:r=()=>{}}){const[a,i]=J.useState(!1);return u(Pf,{icon:e,title:n,component:t,over:a,dropHandler:r,onDragOver:d=>{console.log("drag over"),d.preventDefault(),i(!0)},onDragLeave:d=>{d.preventDefault(),i(!1)},onDrop:d=>{d.preventDefault(),i(!1);const f=d.dataTransfer.files[0];console.log(f),r(f)}})}const Rf=m.div`
...
`;function Af({data:e}){const{headings:n}=e,{rows:t}=e;return z(Rf,{children:[z(Xt,{border:!0,children:[u(Zt,{collapse:!0,children:u(st,{margin:"0px"})}),n.map(r=>u(Zt,{children:u(Fe,{children:r})},r))]}),t.map(r=>z(Xt,{children:[u(Kt,{collapse:!0,children:u(st,{margin:"0px"})}),Object.keys(r).map(a=>u(Kt,{border:!0,justify:a==="actions"?"flex-end":"flex-start",children:a!=="actions"?u(Fe,{children:r[a]}):r[a]},a))]},r.name))]})}const If=m.div`
    color: ${e=>e.theme.main.color};
...
`,Mf=m.div`
    ...
    //padding: 2rem;
    text-align: center;
`;function Df({content:e=null,onClose:n=()=>{},onOpen:t=()=>{},isOpen:r=!1,transparent:a=!1,className:i=null}){return J.useEffect(()=>(t(),()=>{n()}),[n,t]),r?z(jf,{children:[u(Ff,{onClick:()=>n(null)}),u(Mf,{id:"mainModal",transparent:a,children:e})]}):null}const Nf=m.ul`
    overflow-y: auto;
    height: 50vh;
...
`;function Wa({padding:e=null,margin:n,children:t}){return u(Nf,{padding:e,margin:n,children:t})}const zf=m.div`
    padding: 1rem;
