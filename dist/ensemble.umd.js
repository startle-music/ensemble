...
`,Rs=m.p`
    color: ${({inputColour:e})=>e};
    font-family: ${be.main.font};
    font-size: 0.75rem;
    margin: 0.6rem 0;
`,As=({children:e,inputColour:n})=>e===null?null:f(Rs,{inputColour:n,children:e}),Is=({id:e,name:n,inputBackground:t=null,inputColour:r=null,inputBorder:a=null,prepend:i=null,append:o=null,label:s=null,type:c="text",caption:d=null,required:u=!1,placeholder:p=!1,defaultValue:g=null,status:S=null,...E})=>{let P=()=>null;i!==null&&(P=()=>f(wn,{children:i}));let A=()=>null;o!==null&&(A=()=>f(wn,{children:o}));let O={inputBackground:"white",inputColour:"black",inputBorder:be.main.border};return t!==null&&(O={...O,inputBackground:t}),r!==null&&(O={...O,inputColour:r}),a!==null&&(O={...O,inputBorder:a}),z(ln,{htmlFor:n,block:!0,children:[s!==null?f(wr,{required:u,children:s}):null,z(Ps,{...E,...O,children:[f(P,{}),f(Os,{type:c,name:n,required:u,placeholder:p,defaultValue:g,id:e,...O,...E}),f(A,{})]}),f(As,{...O,children:d})]})},_s=m.label`
    font-weight: bold;
...
`,Na=({type:e="heading",children:n,...t})=>{switch(e.toLowerCase()){case"hero":return f(df,{...t,children:n});case"title":return f(mf,{...t,children:n});case"subtitle":return f(pf,{...t,children:n});default:return f(bf,{...t,children:n})}},gf=m.hr`
    width: ${({width:e})=>e};
    margin: 0 auto;
    border-bottom: 1px solid ${({color:e})=>e!==null?e:be.generalColors.midGrey};
...
`,Ef=({children:e,...n})=>f(Tf,{...n,children:e}),Pf=m.div`
    ...
    align-items: center;
    flex-direction: column;
    border: 1px solid ${be.form.input.border};
    width: 100%;
    aspect-ratio: 16/9;
    padding: 2rem;
`,Of=m(Be)`
...
`,Rf=m(Fe)`
    margin-bottom: 1rem;
`;function za({icon:e,title:n="",component:t=null,className:r}){return z(Pf,{className:r,children:[f(Of,{icon:e,color:be.form.input.border}),f(Rf,{type:"heading",children:n}),t]})}const Af=m(za)`
