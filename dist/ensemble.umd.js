(function(y,X){typeof exports=="object"&&typeof module<"u"?X(exports,require("react"),require("styled-components")):typeof define=="function"&&define.amd?define(["exports","react","styled-components"],X):(y=typeof globalThis<"u"?globalThis:y||self,X(y.Ensemble={},y.React,y.styled))})(this,function(y,X,m){"use strict";function ri(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Xn={exports:{}},rn={};/**
 * @license React
...
`,Ds=m.div`
    font-size: 1.4rem;
`,Ns=({id:e,name:n,inputBackground:t=null,background:r=!1,inputColour:a=null,inputBorder:i=null,prepend:o=null,append:s=null,label:c=null,type:d="text",caption:f=null,required:p=!1,placeholder:h=!1,defaultValue:x=null,status:O=null,...T})=>{let A={inputBackground:"white",inputColour:"black",inputBorder:de.main.border};return r&&(A={inputBackground:de.form.input.background,inputColour:de.form.input.color,inputBorder:de.main.border}),t!==null&&(A={...A,inputBackground:t}),a!==null&&(A={...A,inputColour:a}),i!==null&&(A={...A,inputBorder:i}),F(Cn,{htmlFor:n,block:!0,children:[c!==null?u($n,{required:p,children:c}):null,F(Ls,{...T,...A,children:[o?u(zs,{children:o}):null,u(js,{type:d,name:n,required:p,placeholder:h,defaultValue:x,id:e,...A,...T}),s?u(Ds,{children:s}):null]}),u(Ms,{...A,children:f})]})},Bs=m.div`
    display: flex;
    flex-direction: column;
    width: 100%;
`,Ws=m.select`
...
`,Vs=({name:e,label:n="",required:t,checked:r,inline:a=!1,disabled:i=!1,value:o,margin:s=null,backgroundColor:c=null,color:d=null,className:f="",defaultChecked:p=!1,id:h=!1,...x})=>u(qs,{inline:a,className:f,margin:s,children:F(Xs,{htmlFor:h,disabled:i,children:[u(Zs,{type:"radio",checked:r,disabled:i,value:o,name:e,id:h||e,required:t,defaultChecked:r,backgroundColor:c,color:d,margin:n!=="",...x}),n]})}),Ks=m.div`
    width: 100%;
`,Js=m.div`
    display: flex;
    flex-direction: row;
...
`,Cr=m($r)``,Qs=m.div`
    margin: 0 0.5rem;
    color: ${({theme:e})=>e.main.color};
`;function el({label:e,name:n,hourMin:t=0,hourMax:r=23,hourValue:a,minuteMin:i=0,minuteMax:o=59,minuteValue:s}){const[c,d]=X.useState(a),[f,p]=X.useState(s);X.useEffect(()=>{d(a),p(s)},[a,s]);function h(){const O=[];for(let T=t;T<=r;T++)O.push(T<10?`0${T}`:T);return O}function x(){const O=[];for(let T=i;T<=o;T++)O.push(T<10?`0${T}`:T);return O}return F(Ks,{children:[u($n,{children:e}),F(Js,{children:[u(Cr,{value:c,name:`${n}[hour]`,inline:!0,onChange:O=>d(O.target.value),children:h().map(O=>u("option",{value:O,children:O},`${n}-${O}`))},`${n}-hour`),u(Qs,{children:":"}),u(Cr,{value:f,name:`${n}[minute]`,inline:!0,onChange:O=>p(O.target.value),children:x().map(O=>u("option",{value:O,children:O},`${n}-${O}`))},`${n}-minute`)]})]})}const nl=m.textarea`
    width: 100%;
    height: 10rem;
    padding: 0.5rem;
    margin: 0 0 1rem;
...
`,bu=m.div`
    cursor: grab;
`;function gu({children:e,...n}){const[t,r]=X.useState(X.Children.toArray(e)),a=X.useRef(),i=X.useRef();X.useEffect(()=>{r(X.Children.toArray(e))},[e]);const o=f=>{a.current=f},s=f=>{i.current=f},c=f=>{f.preventDefault();const p=i.current;if(p===void 0)return;const h=[...t],x=h[a.current];h.splice(a.current,1),h.splice(p,0,x),a.current=p,r(h)},d=()=>{a.current=null,i.current=null};return u(mu,{...n,children:t.map((f,p)=>u(bu,{draggable:!0,onDragStart:()=>o(p),onDragEnter:()=>s(p),onDragOver:c,onDrop:d,children:f},p))})}const vu=m.div``,yu=m.div`
    position: relative;
...
`,ku=m.div``,$u=m.div``;function Cu({children:e,position:n=0,handleNext:t,handleBack:r,handleEnd:a,endText:i="Submit",handleCancel:o=null,loading:s=!1}){let c=n;return n<0?c=0:n>X.Children.count(e)-1&&(c=X.Children.count(e)-1),F(vu,{children:[F(wu,{children:[u(ar,{progress:c+1,max:X.Children.count(e),size:50,strokeWidth:8}),F(ku,{children:[F(Me,{children:["Step ",c+1," of ",X.Children.count(e)]}),X.Children.map(e,(d,f)=>f===c?u(Da,{children:d.props.title}):null)]}),o?u(fe,{action:!0,small:!0,onClick:o,children:"Cancel"}):null]}),u(yu,{loading:s,children:X.Children.map(e,(d,f)=>f===c?d:null)}),F(xu,{children:[u(fe,{onClick:r,disabled:c===0,neutral:!0,children:"Previous"}),c===X.Children.count(e)-1?u(fe,{onClick:a,children:i}):u(fe,{onClick:t,disabled:c===X.Children.count(e)-1,children:"Next Step"})]})]})}y.ActionPanel=Ba,y.Background=di,y.Button=fe,y.Card=du,y.CardBody=fu,y.CardFooter=uu,y.CardHeader=cu,y.Checkbox=ot,y.Chip=no,y.CircularProgress=ar,y.ColorPicker=ro,y.Column=Oo,y.ColumnContainer=xo,y.ColumnWrapper=To,y.Container=So,y.ContainerContent=Co,y.Content=wo,y.DragDropList=gu,y.DraggableListItem=pu,y.DraggableListItemHandle=hu,y.DroppableActionPanel=Zf,y.FlexTable=gs,y.FlexTableCell=xs,y.FlexTableHead=Es,y.FlexTableHeader=Cs,y.FlexTableRow=ys,y.Form=As,y.FormRow=Os,y.GridContainer=ko,y.Header=yo,y.Heading=Da,y.Hr=Lf,y.IconBoxes=cs,y.Input=Ns,y.InputExpander=Tf,y.Label=$n,y.ListItem=Wa,y.Modal=ou,y.ModalBody=nu,y.ModalFooter=tu,y.ModalHeader=eu,y.Pod=go,y.PositionContainer=vo,y.Radio=Vs,y.RadioPanel=hf,y.Rectangle=hs,y.ResponseBox=Do,y.ResponsiveTable=Qf,y.ScrollableList=Ya,y.Select=$r,y.Step=$u,y.Steps=Cu,y.Switch=yf,y.Tab=Ff,y.TabContent=Hf,y.TabGroup=Wf,y.TabPane=Df,y.TabWrap=Mf,y.Table=Ko,y.TableCell=Zt,y.TableHeading=Xt,y.TableRow=qt,y.Td=rs,y.Text=Me,y.TextArea=tl,y.TextPairs=xr,y.Th=ns,y.TimeSelect=el,y.ToggleArea=hr,y.Tr=Qo,y.extendDefaultTheme=de,Object.defineProperty(y,Symbol.toStringTag,{value:"Module"})});
