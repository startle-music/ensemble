(function(k,oe){typeof exports=="object"&&typeof module<"u"?oe(exports,require("react"),require("styled-components")):typeof define=="function"&&define.amd?define(["exports","react","styled-components"],oe):(k=typeof globalThis<"u"?globalThis:k||self,oe(k.Ensemble={},k.React,k.styled))})(this,function(k,oe,m){"use strict";function ni(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Xn={exports:{}},nn={};/**
 * @license React
...
`;function _f({children:e}){const n=i=>{const{id:o}=i.currentTarget;i.dataTransfer.setData("text/plain",o)},t=i=>{i.preventDefault()},r=i=>{i.preventDefault();const o=i.dataTransfer.getData("text/plain"),s=i.currentTarget.id;if(o===s)return;const c=e.findIndex(g=>g.key===o),u=e.findIndex(g=>g.key===s),f=oe.Children.toArray(e),[p]=f.splice(c,1);f.splice(u,0,p),updateParentList(f)},a=oe.Children.map(e,(i,o)=>oe.cloneElement(i,{id:`draggable-item-${o}`,draggable:"true",onDragStart:n,onDragOver:t,onDrop:r}));return d(Rf,{children:a})}k.ActionPanel=Na,k.Background=si,k.Button=ke,k.Card=Of,k.CardBody=Tf,k.CardFooter=Pf,k.CardHeader=Ef,k.Checkbox=ot,k.Chip=Zi,k.ColorPicker=Ki,k.Column=ko,k.ColumnContainer=bo,k.ColumnWrapper=xo,k.Container=vo,k.Content=po,k.DragDropList=_f,k.DraggableListItem=Af,k.DraggableListItemHandle=If,k.DroppableActionPanel=hf,k.FlexTable=fs,k.FlexTableCell=ps,k.FlexTableHead=ys,k.FlexTableHeader=hs,k.FlexTableRow=ds,k.Form=Cs,k.FormRow=ks,k.GridContainer=go,k.Header=mo,k.Heading=Js,k.Hr=el,k.IconBoxes=ts,k.Input=As,k.Label=Sn,k.ListItem=za,k.Modal=Cf,k.Pod=fo,k.PositionContainer=uo,k.Radio=Ys,k.Rectangle=ls,k.ResponseBox=Io,k.ResponsiveTable=yf,k.ScrollableList=Ba,k.Select=kr,k.Tab=tl,k.TabContent=fl,k.TabGroup=ll,k.TabPane=il,k.TabWrap=rl,k.Table=Ho,k.TableCell=Zt,k.TableHeading=Xt,k.TableRow=qt,k.Td=Vo,k.Text=on,k.TextPairs=yr,k.Th=Xo,k.TimeSelect=qs,k.ToggleArea=mr,k.Tr=Uo,k.extendDefaultTheme=he,Object.defineProperty(k,Symbol.toStringTag,{value:"Module"})});
