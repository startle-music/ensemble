...
`,Rf=m(Fe)`
    margin-bottom: 1rem;
`;function za({icon:e,title:n="",component:t=null,className:r}){return z(Pf,{className:r,children:[f(Of,{icon:e,color:xe.form.input.border}),f(Rf,{type:"heading",children:n}),t]})}const Af=m(za)`
