...
`;function Cs({inline:e=!1,grid:n=!1,nested:t,children:r}){return d(ks,{inline:e,nested:t,grid:n,children:r})}function Ss({children:e,submitButton:n,onSubmit:t,forwardRef:r=null}){return H(ws,{ref:r,onSubmit:t,children:[e,n]})}const $s=m.css`
    //margin-bottom:5px;
    //font-size: 0.9rem;
...
`,Rs=m.p`
    ...
    font-size: 0.75rem;
    margin: 0.6rem 0;
`,As=({children:e,inputColour:n})=>e===null?null:d(Rs,{inputColour:n,children:e}),Is=({id:e,name:n,inputBackground:t=null,inputColour:r=null,inputBorder:a=null,prepend:i=null,append:o=null,label:s=null,type:c="text",caption:u=null,required:f=!1,placeholder:p=!1,defaultValue:g=null,status:S=null,...L})=>{let P=()=>null;i!==null&&(P=()=>d(xn,{children:i}));let R=()=>null;o!==null&&(R=()=>d(xn,{children:o}));let E={inputBackground:"white",inputColour:"black",inputBorder:he.main.border};return t!==null&&(E={...E,inputBackground:t}),r!==null&&(E={...E,inputColour:r}),a!==null&&(E={...E,inputBorder:a}),H(Sn,{htmlFor:n,block:!0,children:[s!==null?d(wr,{required:f,children:s}):null,H(Ps,{...L,...E,children:[d(P,{}),d(Os,{type:c,name:n,required:f,placeholder:p,defaultValue:g,id:e,...E,...L}),d(R,{})]}),d(As,{...E,children:u})]})},_s=m.label`
    font-weight: bold;
...
`,$f=m(Fe)`
    margin-bottom: 1rem;
`;function za({icon:e,title:n="",component:t=null,className:r}){return H(Cf,{className:r,children:[d(Sf,{icon:e,color:he.form.input.border}),d($f,{type:"heading",children:n}),t]})}const Tf=m(za)`
