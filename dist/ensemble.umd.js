(function(C,oe){typeof exports=="object"&&typeof module<"u"?oe(exports,require("react"),require("styled-components")):typeof define=="function"&&define.amd?define(["exports","react","styled-components"],oe):(C=typeof globalThis<"u"?globalThis:C||self,oe(C.Ensemble={},C.React,C.styled))})(this,function(C,oe,m){"use strict";function ni(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Xn={exports:{}},nn={};/**
 * @license React
...
`+Y[te].replace(" at new "," at ");return l.displayName&&ge.includes("<anonymous>")&&(ge=ge.replace("<anonymous>",l.displayName)),typeof l=="function"&&W.set(l,ge),ge}while(te>=1&&re>=0);break}}}finally{q=!1,j.current=J,G(),Error.prepareStackTrace=X}var en=l?l.displayName||l.name:"",ei=en?B(en):"";return typeof l=="function"&&W.set(l,ei),ei}function be(l,b,y){return w(l,!1)}function Je(l){var b=l.prototype;return!!(b&&b.isReactComponent)}function We(l,b,y){if(l==null)return"";if(typeof l=="function")return w(l,Je(l));if(typeof l=="string")return B(l);switch(l){case u:return B("Suspense");case f:return B("SuspenseList")}if(typeof l=="object")switch(l.$$typeof){case c:return be(l.render);case p:return We(l.type,b,y);case g:{var A=l,X=A._payload,J=A._init;try{return We(J(X),b,y)}catch{}}}return""}var Un=Object.prototype.hasOwnProperty,Wa={},Ya=T.ReactDebugCurrentFrame;function qn(l){if(l){var b=l._owner,y=We(l.type,l._source,b?b.type:null);Ya.setExtraStackFrame(y)}else Ya.setExtraStackFrame(null)}function Lf(l,b,y,A,X){{var J=Function.call.bind(Un);for(var U in l)if(J(l,U)){var Y=void 0;try{if(typeof l[U]!="function"){var ce=Error((A||"React class")+": "+y+" type `"+U+"` is invalid; it must be a function, usually from the `prop-types` package, but received `"+typeof l[U]+"`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");throw ce.name="Invariant Violation",ce}Y=l[U](b,U,A,y,null,"SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED")}catch(te){Y=te}Y&&!(Y instanceof Error)&&(qn(X),I("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).",A||"React class",y,U,typeof Y),qn(null)),Y instanceof Error&&!(Y.message in Wa)&&(Wa[Y.message]=!0,qn(X),I("Failed %s type: %s",y,Y.message),qn(null))}}}var jf=Array.isArray;function Vt(l){return jf(l)}function Ff(l){{var b=typeof Symbol=="function"&&Symbol.toStringTag,y=b&&l[Symbol.toStringTag]||l.constructor.name||"Object";return y}}function Mf(l){try{return Ha(l),!1}catch{return!0}}function Ha(l){return""+l}function Ga(l){if(Mf(l))return I("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.",Ff(l)),Ha(l)}var yn=T.ReactCurrentOwner,Df={key:!0,ref:!0,__self:!0,__source:!0},Ua,qa,Kt;Kt={};function Nf(l){if(Un.call(l,"ref")){var b=Object.getOwnPropertyDescriptor(l,"ref").get;if(b&&b.isReactWarning)return!1}return l.ref!==void 0}function zf(l){if(Un.call(l,"key")){var b=Object.getOwnPropertyDescriptor(l,"key").get;if(b&&b.isReactWarning)return!1}return l.key!==void 0}function Bf(l,b){if(typeof l.ref=="string"&&yn.current&&b&&yn.current.stateNode!==b){var y=me(yn.current.type);Kt[y]||(I('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref',me(yn.current.type),l.ref),Kt[y]=!0)}}function Wf(l,b){{var y=function(){Ua||(Ua=!0,I("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",b))};y.isReactWarning=!0,Object.defineProperty(l,"key",{get:y,configurable:!0})}}function Yf(l,b){{var y=function(){qa||(qa=!0,I("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",b))};y.isReactWarning=!0,Object.defineProperty(l,"ref",{get:y,configurable:!0})}}var Hf=function(l,b,y,A,X,J,U){var Y={$$typeof:n,type:l,key:b,ref:y,props:U,_owner:J};return Y._store={},Object.defineProperty(Y._store,"validated",{configurable:!1,enumerable:!1,writable:!0,value:!1}),Object.defineProperty(Y,"_self",{configurable:!1,enumerable:!1,writable:!1,value:A}),Object.defineProperty(Y,"_source",{configurable:!1,enumerable:!1,writable:!1,value:X}),Object.freeze&&(Object.freeze(Y.props),Object.freeze(Y)),Y};function Gf(l,b,y,A,X){{var J,U={},Y=null,ce=null;y!==void 0&&(Ga(y),Y=""+y),zf(b)&&(Ga(b.key),Y=""+b.key),Nf(b)&&(ce=b.ref,Bf(b,X));for(J in b)Un.call(b,J)&&!Df.hasOwnProperty(J)&&(U[J]=b[J]);if(l&&l.defaultProps){var te=l.defaultProps;for(J in te)U[J]===void 0&&(U[J]=te[J])}if(Y||ce){var re=typeof l=="function"?l.displayName||l.name||"Unknown":l;Y&&Wf(U,re),ce&&Yf(U,re)}return Hf(l,Y,ce,X,A,yn.current,U)}}var Jt=T.ReactCurrentOwner,Xa=T.ReactDebugCurrentFrame;function Qe(l){if(l){var b=l._owner,y=We(l.type,l._source,b?b.type:null);Xa.setExtraStackFrame(y)}else Xa.setExtraStackFrame(null)}var Qt;Qt=!1;function er(l){return typeof l=="object"&&l!==null&&l.$$typeof===n}function Za(){{if(Jt.current){var l=me(Jt.current.type);if(l)return`

Check the render method of \``+l+"`."}return""}}function Uf(l){{if(l!==void 0){var b=l.fileName.replace(/^.*[\\\/]/,""),y=l.lineNumber;return`

Check your code at `+b+":"+y+"."}return""}}var Va={};function qf(l){{var b=Za();if(!b){var y=typeof l=="string"?l:l.displayName||l.name;y&&(b=`

Check the top-level render call using <`+y+">.")}return b}}function Ka(l,b){{if(!l._store||l._store.validated||l.key!=null)return;l._store.validated=!0;var y=qf(b);if(Va[y])return;Va[y]=!0;var A="";l&&l._owner&&l._owner!==Jt.current&&(A=" It was passed a child from "+me(l._owner.type)+"."),Qe(l),I('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.',y,A),Qe(null)}}function Ja(l,b){{if(typeof l!="object")return;if(Vt(l))for(var y=0;y<l.length;y++){var A=l[y];er(A)&&Ka(A,b)}else if(er(l))l._store&&(l._store.validated=!0);else if(l){var X=R(l);if(typeof X=="function"&&X!==l.entries)for(var J=X.call(l),U;!(U=J.next()).done;)er(U.value)&&Ka(U.value,b)}}}function Xf(l){{var b=l.type;if(b==null||typeof b=="string")return;var y;if(typeof b=="function")y=b.propTypes;else if(typeof b=="object"&&(b.$$typeof===c||b.$$typeof===p))y=b.propTypes;else return;if(y){var A=me(b);Lf(y,l.props,"prop",A,l)}else if(b.PropTypes!==void 0&&!Qt){Qt=!0;var X=me(b);I("Component %s declared `PropTypes` instead of `propTypes`. Did you misspell the property assignment?",X||"Unknown")}typeof b.getDefaultProps=="function"&&!b.getDefaultProps.isReactClassApproved&&I("getDefaultProps is only used on classic React.createClass definitions. Use a static property named `defaultProps` instead.")}}function Zf(l){{for(var b=Object.keys(l.props),y=0;y<b.length;y++){var A=b[y];if(A!=="children"&&A!=="key"){Qe(l),I("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.",A),Qe(null);break}}l.ref!==null&&(Qe(l),I("Invalid attribute `ref` supplied to `React.Fragment`."),Qe(null))}}function Qa(l,b,y,A,X,J){{var U=ze(l);if(!U){var Y="";(l===void 0||typeof l=="object"&&l!==null&&Object.keys(l).length===0)&&(Y+=" You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports.");var ce=Uf(X);ce?Y+=ce:Y+=Za();var te;l===null?te="null":Vt(l)?te="array":l!==void 0&&l.$$typeof===n?(te="<"+(me(l.type)||"Unknown")+" />",Y=" Did you accidentally export a JSX literal instead of a component?"):te=typeof l,I("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s",te,Y)}var re=Gf(l,b,y,X,J);if(re==null)return re;if(U){var ge=b.children;if(ge!==void 0)if(A)if(Vt(ge)){for(var en=0;en<ge.length;en++)Ja(ge[en],l);Object.freeze&&Object.freeze(ge)}else I("React.jsx: Static children should always be an array. You are likely explicitly calling React.jsxs or React.jsxDEV. Use the Babel transform instead.");else Ja(ge,l)}return l===r?Zf(re):Xf(re),re}}function Vf(l,b,y){return Qa(l,b,y,!0)}function Kf(l,b,y){return Qa(l,b,y,!1)}var Jf=Kf,Qf=Vf;tn.Fragment=r,tn.jsx=Jf,tn.jsxs=Qf}()),tn}process.env.NODE_ENV==="production"?Xn.exports=ti():Xn.exports=ri();var Zn=Xn.exports;const wn=Zn.Fragment,d=Zn.jsx,K=Zn.jsxs,ai=m.div`
    position: fixed;
    top: 0;
    left: 0;
    right: 0;
...
`,Os=m.p`
    ...
    font-size: 0.75rem;
    margin: 0.6rem 0;
`,Rs=({children:e,inputColour:n})=>e===null?null:d(Os,{inputColour:n,children:e}),As=({id:e,name:n,inputBackground:t=null,inputColour:r=null,inputBorder:a=null,prepend:i=null,append:o=null,label:s=null,type:c="text",caption:u=null,required:f=!1,placeholder:p=!1,defaultValue:g=null,status:S=null,...L})=>{let P=()=>null;i!==null&&(P=()=>d(wn,{children:i}));let R=()=>null;o!==null&&(R=()=>d(wn,{children:o}));let T={inputBackground:"white",inputColour:"black",inputBorder:ye.main.border};return t!==null&&(T={...T,inputBackground:t}),r!==null&&(T={...T,inputColour:r}),a!==null&&(T={...T,inputBorder:a}),K(Sn,{htmlFor:n,block:!0,children:[s!==null?d(xr,{required:f,children:s}):null,K(Ts,{...L,...T,children:[d(P,{}),d(Ps,{type:c,name:n,required:f,placeholder:p,defaultValue:g,id:e,...T,...L}),d(R,{})]}),d(Rs,{...T,children:u})]})},Is=m.label`
    font-weight: bold;
...
`,Js=({type:e="heading",children:n,...t})=>{switch(e.toLowerCase()){case"hero":return d(Xs,{...t,children:n});case"title":return d(Zs,{...t,children:n});case"subtitle":return d(Vs,{...t,children:n});default:return d(Ks,{...t,children:n})}},Qs=m.hr`
    width: ${({width:e})=>e};
    margin: 0 auto;
    border-bottom: 1px solid ${({color:e})=>e!==null?e:ye.generalColors.midGrey};
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function of(e){var n,t=e.beat,r=e.fade,a=e.beatFade,i=e.bounce,o=e.shake,s=e.flash,c=e.spin,u=e.spinPulse,f=e.spinReverse,p=e.pulse,g=e.fixedWidth,S=e.inverse,L=e.border,P=e.listItem,R=e.flip,T=e.size,I=e.rotation,M=e.pull,H=(n={"fa-beat":t,"fa-fade":r,"fa-beat-fade":a,"fa-bounce":i,"fa-shake":o,"fa-flash":s,"fa-spin":c,"fa-spin-reverse":f,"fa-spin-pulse":u,"fa-pulse":p,"fa-fw":g,"fa-inverse":S,"fa-border":L,"fa-li":P,"fa-flip":R===!0,"fa-flip-horizontal":R==="horizontal"||R==="both","fa-flip-vertical":R==="vertical"||R==="both"},Xe(n,"fa-".concat(T),typeof T<"u"&&T!==null),Xe(n,"fa-rotate-".concat(I),typeof I<"u"&&I!==null&&I!==0),Xe(n,"fa-pull-".concat(M),typeof M<"u"&&M!==null),Xe(n,"fa-swap-opacity",e.swapOpacity),n);return Object.keys(H).map(function(v){return H[v]?v:null}).filter(function(v){return v})}function sf(e){return e=e-0,e===e}function ja(e){return sf(e)?e:(e=e.replace(/[\-_\s]+(.)?/g,function(n,t){return t?t.toUpperCase():""}),e.substr(0,1).toLowerCase()+e.substr(1))}var lf=["style"];function cf(e){return e.charAt(0).toUpperCase()+e.slice(1)}function ff(e){return e.split(";").map(function(n){return n.trim()}).filter(function(n){return n}).reduce(function(n,t){var r=t.indexOf(":"),a=ja(t.slice(0,r)),i=t.slice(r+1).trim();return a.startsWith("webkit")?n[cf(a)]=i:n[a]=i,n},{})}function Fa(e,n){var t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{};if(typeof n=="string")return n;var r=(n.children||[]).map(function(c){return Fa(e,c)}),a=Object.keys(n.attributes||{}).reduce(function(c,u){var f=n.attributes[u];switch(u){case"class":c.attrs.className=f,delete n.attributes.class;break;case"style":c.attrs.style=ff(f);break;default:u.indexOf("aria-")===0||u.indexOf("data-")===0?c.attrs[u.toLowerCase()]=f:c.attrs[ja(u)]=f}return c},{attrs:{}}),i=t.style,o=i===void 0?{}:i,s=ef(t,lf);return a.attrs.style=Le(Le({},a.attrs.style),o),e.apply(void 0,[n.tag,Le(Le({},a.attrs),s)].concat(Ht(r)))}var Ma=!1;try{Ma=process.env.NODE_ENV==="production"}catch{}function uf(){if(!Ma&&console&&typeof console.error=="function"){var e;(e=console).error.apply(e,arguments)}}function Da(e){if(e&&Gn(e)==="object"&&e.prefix&&e.iconName&&e.icon)return e;if(jt.icon)return jt.icon(e);if(e===null)return null;if(e&&Gn(e)==="object"&&e.prefix&&e.iconName)return e;if(Array.isArray(e)&&e.length===2)return{prefix:e[0],iconName:e[1]};if(typeof e=="string")return{prefix:"fas",iconName:e}}function Ut(e,n){return Array.isArray(n)&&n.length>0||!Array.isArray(n)&&n?Xe({},e,n):{}}var vn=oe.forwardRef(function(e,n){var t=e.icon,r=e.mask,a=e.symbol,i=e.className,o=e.title,s=e.titleId,c=e.maskId,u=Da(t),f=Ut("classes",[].concat(Ht(of(e)),Ht(i.split(" ")))),p=Ut("transform",typeof e.transform=="string"?jt.transform(e.transform):e.transform),g=Ut("mask",Da(r)),S=Yc(u,Le(Le(Le(Le({},f),p),g),{},{symbol:a,title:o,titleId:s,maskId:c}));if(!S)return uf("Could not find icon",u),null;var L=S.abstract,P={ref:n};return Object.keys(e).forEach(function(R){vn.defaultProps.hasOwnProperty(R)||(P[R]=e[R])}),df(L[0],P)});vn.displayName="FontAwesomeIcon",vn.propTypes={beat:z.bool,border:z.bool,beatFade:z.bool,bounce:z.bool,className:z.string,fade:z.bool,flash:z.bool,mask:z.oneOfType([z.object,z.array,z.string]),maskId:z.string,fixedWidth:z.bool,inverse:z.bool,flip:z.oneOf([!0,!1,"horizontal","vertical","both"]),icon:z.oneOfType([z.object,z.array,z.string]),listItem:z.bool,pull:z.oneOf(["right","left"]),pulse:z.bool,rotation:z.oneOf([0,90,180,270]),shake:z.bool,size:z.oneOf(["2xs","xs","sm","lg","xl","2xl","1x","2x","3x","4x","5x","6x","7x","8x","9x","10x"]),spin:z.bool,spinPulse:z.bool,spinReverse:z.bool,symbol:z.oneOfType([z.bool,z.string]),title:z.string,titleId:z.string,transform:z.oneOfType([z.string,z.object]),swapOpacity:z.bool},vn.defaultProps={border:!1,className:"",mask:null,maskId:null,fixedWidth:!1,inverse:!1,flip:!1,icon:null,listItem:!1,pull:null,pulse:!1,rotation:null,size:null,spin:!1,spinPulse:!1,spinReverse:!1,beat:!1,fade:!1,beatFade:!1,bounce:!1,shake:!1,symbol:!1,title:"",titleId:null,transform:null,swapOpacity:!1};var df=Fa.bind(null,oe.createElement);const mf=m.div`
    ...
    align-items: center;
    flex-direction: column;
    border: 1px solid ${ye.form.input.border};
    width: 100%;
    aspect-ratio: 16/9;
    padding: 2rem;
`,pf=m(vn)`
...
`,bf=m(on)`
    margin-bottom: 1rem;
`;function Na({icon:e,title:n="",component:t=null,className:r}){return K(mf,{className:r,children:[d(pf,{icon:e,color:ye.form.input.border}),d(bf,{type:"heading",children:n}),t]})}const gf=m(Na)`
...
`,kf=m.div`
    ...
    //padding: 2rem;
    text-align: center;
`;function Cf({content:e=null,onClose:n=()=>{},onOpen:t=()=>{},isOpen:r=!1,transparent:a=!1,className:i=null}){return oe.useEffect(()=>(t(),()=>{n()}),[n,t]),r?K(wf,{children:[d(xf,{onClick:()=>n(null)}),d(kf,{id:"mainModal",transparent:a,children:e})]}):null}const Sf=m.ul`
    overflow-y: auto;
    height: 50vh;
...
`;function Ba({padding:e=null,margin:n,children:t}){return d(Sf,{padding:e,margin:n,children:t})}const $f=m.div`
    padding: 1rem;
...
`,Pf=m.div`
    ...
    border-bottom: ${e=>e.border?`1px solid ${e.theme.main.border}`:"none"};
    margin-left: auto;
`;function Of({horizontal:e,margin:n,border:t=!0,children:r}){return d($f,{horizontal:e,margin:n,border:t,children:r})}const Rf=m(Ba)`
    & .placeholder {
...
`;function _f({children:e}){const n=i=>{const{id:o}=i.currentTarget;i.dataTransfer.setData("text/plain",o)},t=i=>{i.preventDefault()},r=i=>{i.preventDefault();const o=i.dataTransfer.getData("text/plain"),s=i.currentTarget.id;if(o===s)return;const c=e.findIndex(g=>g.key===o),u=e.findIndex(g=>g.key===s),f=oe.Children.toArray(e),[p]=f.splice(c,1);f.splice(u,0,p),updateParentList(f)},a=oe.Children.map(e,(i,o)=>oe.cloneElement(i,{id:`draggable-item-${o}`,draggable:"true",onDragStart:n,onDragOver:t,onDrop:r}));return d(Rf,{children:a})}C.ActionPanel=Na,C.Background=si,C.Button=ke,C.Card=Of,C.CardBody=Tf,C.CardFooter=Pf,C.CardHeader=Ef,C.Checkbox=ot,C.Chip=Zi,C.ColorPicker=Ki,C.Column=ko,C.ColumnContainer=bo,C.ColumnWrapper=xo,C.Container=vo,C.Content=po,C.DragDropList=_f,C.DraggableListItem=Af,C.DraggableListItemHandle=If,C.DroppableActionPanel=hf,C.FlexTable=fs,C.FlexTableCell=ps,C.FlexTableHead=ys,C.FlexTableHeader=hs,C.FlexTableRow=ds,C.Form=Cs,C.FormRow=ks,C.GridContainer=go,C.Header=mo,C.Heading=Js,C.Hr=el,C.IconBoxes=ts,C.Input=As,C.Label=Sn,C.ListItem=za,C.Modal=Cf,C.Pod=fo,C.PositionContainer=uo,C.Radio=Ys,C.Rectangle=ls,C.ResponseBox=Io,C.ResponsiveTable=yf,C.ScrollableList=Ba,C.Select=kr,C.Tab=tl,C.TabContent=fl,C.TabGroup=ll,C.TabPane=il,C.TabWrap=rl,C.Table=Ho,C.TableCell=Zt,C.TableHeading=Xt,C.TableRow=qt,C.Td=Vo,C.Text=on,C.TextPairs=yr,C.Th=Xo,C.TimeSelect=qs,C.ToggleArea=mr,C.Tr=Uo,Object.defineProperty(C,Symbol.toStringTag,{value:"Module"})});
