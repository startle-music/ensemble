...
`,Rs=m.p`
    ...
    font-size: 0.75rem;
    margin: 0.6rem 0;
`,As=({children:e,inputColour:n})=>e===null?null:f(Rs,{inputColour:n,children:e}),Is=({id:e,name:n,inputBackground:t=null,inputColour:r=null,inputBorder:a=null,prepend:i=null,append:o=null,label:s=null,type:c="text",caption:d=null,required:u=!1,placeholder:p=!1,defaultValue:g=null,status:S=null,...E})=>{let P=()=>null;i!==null&&(P=()=>f(wn,{children:i}));let A=()=>null;o!==null&&(A=()=>f(wn,{children:o}));let O={inputBackground:"white",inputColour:"black",inputBorder:ve.main.border};return t!==null&&(O={...O,inputBackground:t}),r!==null&&(O={...O,inputColour:r}),a!==null&&(O={...O,inputBorder:a}),z(ln,{htmlFor:n,block:!0,children:[s!==null?f(wr,{required:u,children:s}):null,z(Ps,{...E,...O,children:[f(P,{}),f(Os,{type:c,name:n,required:u,placeholder:p,defaultValue:g,id:e,...O,...E}),f(A,{})]}),f(As,{...O,children:d})]})},_s=m.label`
    font-weight: bold;
...
`,Rf=m(Fe)`
    margin-bottom: 1rem;
`;function za({icon:e,title:n="",component:t=null,className:r}){return z(Pf,{className:r,children:[f(Of,{icon:e,color:ve.form.input.border}),f(Rf,{type:"heading",children:n}),t]})}const Af=m(za)`
