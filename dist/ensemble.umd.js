...
`+H[re].replace(" at new "," at ");return l.displayName&&ge.includes("<anonymous>")&&(ge=ge.replace("<anonymous>",l.displayName)),typeof l=="function"&&Y.set(l,ge),ge}while(re>=1&&ae>=0);break}}}finally{X=!1,j.current=J,U(),Error.prepareStackTrace=Z}var tn=l?l.displayName||l.name:"",ni=tn?W(tn):"";return typeof l=="function"&&Y.set(l,ni),ni}function be(l,b,x){return k(l,!1)}function en(l){var b=l.prototype;return!!(b&&b.isReactComponent)}function He(l,b,x){if(l==null)return"";if(typeof l=="function")return k(l,en(l));if(typeof l=="string")return W(l);switch(l){case d:return W("Suspense");case f:return W("SuspenseList")}if(typeof l=="object")switch(l.$$typeof){case c:return be(l.render);case p:return He(l.type,b,x);case g:{var I=l,Z=I._payload,J=I._init;try{return He(J(Z),b,x)}catch{}}}return""}var Un=Object.prototype.hasOwnProperty,Ya={},Ha=O.ReactDebugCurrentFrame;function qn(l){if(l){var b=l._owner,x=He(l.type,l._source,b?b.type:null);Ha.setExtraStackFrame(x)}else Ha.setExtraStackFrame(null)}function iu(l,b,x,I,Z){{var J=Function.call.bind(Un);for(var q in l)if(J(l,q)){var H=void 0;try{if(typeof l[q]!="function"){var ce=Error((I||"React class")+": "+x+" type `"+q+"` is invalid; it must be a function, usually from the `prop-types` package, but received `"+typeof l[q]+"`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");throw ce.name="Invariant Violation",ce}H=l[q](b,q,I,x,null,"SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED")}catch(re){H=re}H&&!(H instanceof Error)&&(qn(Z),_("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).",I||"React class",x,q,typeof H),qn(null)),H instanceof Error&&!(H.message in Ya)&&(Ya[H.message]=!0,qn(Z),_("Failed %s type: %s",x,H.message),qn(null))}}}var ou=Array.isArray;function Vt(l){return ou(l)}function su(l){{var b=typeof Symbol=="function"&&Symbol.toStringTag,x=b&&l[Symbol.toStringTag]||l.constructor.name||"Object";return x}}function lu(l){try{return Ga(l),!1}catch{return!0}}function Ga(l){return""+l}function Ua(l){if(lu(l))return _("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.",su(l)),Ga(l)}var wn=O.ReactCurrentOwner,cu={key:!0,ref:!0,__self:!0,__source:!0},qa,Xa,Jt;Jt={};function fu(l){if(Un.call(l,"ref")){var b=Object.getOwnPropertyDescriptor(l,"ref").get;if(b&&b.isReactWarning)return!1}return l.ref!==void 0}function uu(l){if(Un.call(l,"key")){var b=Object.getOwnPropertyDescriptor(l,"key").get;if(b&&b.isReactWarning)return!1}return l.key!==void 0}function du(l,b){if(typeof l.ref=="string"&&wn.current&&b&&wn.current.stateNode!==b){var x=me(wn.current.type);Jt[x]||(_('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref',me(wn.current.type),l.ref),Jt[x]=!0)}}function mu(l,b){{var x=function(){qa||(qa=!0,_("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",b))};x.isReactWarning=!0,Object.defineProperty(l,"key",{get:x,configurable:!0})}}function pu(l,b){{var x=function(){Xa||(Xa=!0,_("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",b))};x.isReactWarning=!0,Object.defineProperty(l,"ref",{get:x,configurable:!0})}}var bu=function(l,b,x,I,Z,J,q){var H={$$typeof:n,type:l,key:b,ref:x,props:q,_owner:J};return H._store={},Object.defineProperty(H._store,"validated",{configurable:!1,enumerable:!1,writable:!0,value:!1}),Object.defineProperty(H,"_self",{configurable:!1,enumerable:!1,writable:!1,value:I}),Object.defineProperty(H,"_source",{configurable:!1,enumerable:!1,writable:!1,value:Z}),Object.freeze&&(Object.freeze(H.props),Object.freeze(H)),H};function gu(l,b,x,I,Z){{var J,q={},H=null,ce=null;x!==void 0&&(Ua(x),H=""+x),uu(b)&&(Ua(b.key),H=""+b.key),fu(b)&&(ce=b.ref,du(b,Z));for(J in b)Un.call(b,J)&&!cu.hasOwnProperty(J)&&(q[J]=b[J]);if(l&&l.defaultProps){var re=l.defaultProps;for(J in re)q[J]===void 0&&(q[J]=re[J])}if(H||ce){var ae=typeof l=="function"?l.displayName||l.name||"Unknown":l;H&&mu(q,ae),ce&&pu(q,ae)}return bu(l,H,ce,Z,I,wn.current,q)}}var Qt=O.ReactCurrentOwner,Za=O.ReactDebugCurrentFrame;function nn(l){if(l){var b=l._owner,x=He(l.type,l._source,b?b.type:null);Za.setExtraStackFrame(x)}else Za.setExtraStackFrame(null)}var er;er=!1;function nr(l){return typeof l=="object"&&l!==null&&l.$$typeof===n}function Ka(){{if(Qt.current){var l=me(Qt.current.type);if(l)return`
...
`,ts=m.div`
    ...
    margin-right:.5rem;
    color: ${e=>e.fill};
`,rs=({fill:e,leftText:n="",rightText:t="",Icon:r})=>z(ns,{children:[u(ts,{fill:e,children:u(r,{fill:e})}),u(wr,{fill:e,leftText:n,rightText:t})]}),it=m.css`
...
`;function Cs({inline:e=!1,display:n=!1,nested:t,children:r}){return u(ks,{inline:e,nested:t,display:n,children:r})}function Ss({children:e,submitButton:n,onSubmit:t,forwardRef:r=null,...a}){return z(xs,{ref:r,onSubmit:t,...a,children:[e,n]})}const $s=m.css`
    //margin-bottom:5px;
    //font-size: 0.9rem;
...
`,Rs=m.p`
    ...
    font-size: 0.75rem;
    margin: 0.6rem 0;
`,As=({children:e,inputColour:n})=>e===null?null:u(Rs,{inputColour:n,children:e}),Is=({id:e,name:n,inputBackground:t=null,inputColour:r=null,inputBorder:a=null,prepend:i=null,append:o=null,label:s=null,type:c="text",caption:d=null,required:f=!1,placeholder:p=!1,defaultValue:g=null,status:S=null,...E})=>{let P=()=>null;i!==null&&(P=()=>u(xn,{children:i}));let A=()=>null;o!==null&&(A=()=>u(xn,{children:o}));let O={inputBackground:"white",inputColour:"black",inputBorder:we.main.border};return t!==null&&(O={...O,inputBackground:t}),r!==null&&(O={...O,inputColour:r}),a!==null&&(O={...O,inputBorder:a}),z(ln,{htmlFor:n,block:!0,children:[s!==null?u(ot,{required:f,children:s}):null,z(Ps,{...E,...O,children:[u(P,{}),u(Os,{type:c,name:n,required:f,placeholder:p,defaultValue:g,id:e,...O,...E}),u(A,{})]}),u(As,{...O,children:d})]})};m.label`
    font-weight: bold;
