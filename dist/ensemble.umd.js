...
`,Rs=m.p`
    ...
    font-size: 0.75rem;
    margin: 0.6rem 0;
`,Is=({children:e,inputColour:n})=>e===null?null:u(Rs,{inputColour:n,children:e}),_s=({id:e,name:n,inputBackground:t=null,inputColour:r=null,inputBorder:a=null,prepend:i=null,append:o=null,label:s=null,type:c="text",caption:d=null,required:f=!1,placeholder:p=!1,defaultValue:b=null,status:$=null,...E})=>{let P=()=>null;i!==null&&(P=()=>u(wn,{children:i}));let R=()=>null;o!==null&&(R=()=>u(wn,{children:o}));let O={inputBackground:"white",inputColour:"black",inputBorder:ke.main.border};return t!==null&&(O={...O,inputBackground:t}),r!==null&&(O={...O,inputColour:r}),a!==null&&(O={...O,inputBorder:a}),N(Sn,{htmlFor:n,block:!0,children:[s!==null?u(Cn,{required:f,children:s}):null,N(Os,{...E,...O,children:[u(P,{}),u(As,{type:c,name:n,required:f,placeholder:p,defaultValue:b,id:e,...O,...E}),u(R,{})]}),u(Is,{...O,children:d})]})},Ls=m.div`
    display: flex;
    flex-direction: column;
    width: 100%;
`,js=m.select`
