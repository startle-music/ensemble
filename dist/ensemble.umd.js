 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var tr;function ai(){return tr||(tr=1,process.env.NODE_ENV!=="production"&&function(){var e=K,n=Symbol.for("react.element"),t=Symbol.for("react.portal"),r=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),i=Symbol.for("react.profiler"),o=Symbol.for("react.provider"),s=Symbol.for("react.context"),c=Symbol.for("react.forward_ref"),d=Symbol.for("react.suspense"),f=Symbol.for("react.suspense_list"),p=Symbol.for("react.memo"),b=Symbol.for("react.lazy"),$=Symbol.for("react.offscreen"),O=Symbol.iterator,E="@@iterator";function A(l){if(l===null||typeof l!="object")return null;var h=O&&l[O]||l[E];return typeof h=="function"?h:null}var F=e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;function I(l){{for(var h=arguments.length,x=new Array(h>1?h-1:0),R=1;R<h;R++)x[R-1]=arguments[R];M("error",l,x)}}function M(l,h,x){{var R=F.ReactDebugCurrentFrame,Z=R.getStackAddendum();Z!==""&&(h+="%s",x=x.concat([Z]));var Q=x.map(function(q){return String(q)});Q.unshift("Warning: "+h),Function.prototype.apply.call(console[l],console,Q)}}var G=!1,v=!1,oe=!1,me=!1,Pe=!1,le;le=Symbol.for("react.module.reference");function We(l){return!!(typeof l=="string"||typeof l=="function"||l===r||l===i||Pe||l===a||l===d||l===f||me||l===$||G||v||oe||typeof l=="object"&&l!==null&&(l.$$typeof===b||l.$$typeof===p||l.$$typeof===o||l.$$typeof===s||l.$$typeof===c||l.$$typeof===le||l.getModuleId!==void 0))}function Je(l,h,x){var R=l.displayName;if(R)return R;var Z=h.displayName||h.name||"";return Z!==""?x+"("+Z+")":x}function Ve(l){return l.displayName||"Context"}function pe(l){if(l==null)return null;if(typeof l.tag=="number"&&I("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."),typeof l=="function")return l.displayName||l.name||null;if(typeof l=="string")return l;switch(l){case r:return"Fragment";case t:return"Portal";case i:return"Profiler";case a:return"StrictMode";case d:return"Suspense";case f:return"SuspenseList"}if(typeof l=="object")switch(l.$$typeof){case s:var h=l;return Ve(h)+".Consumer";case o:var x=l;return Ve(x._context)+".Provider";case c:return Je(l,l.render,"ForwardRef");case p:var R=l.displayName||null;return R!==null?R:pe(l.type)||"Memo";case b:{var Z=l,Q=Z._payload,q=Z._init;try{return pe(q(Q))}catch{return null}}}return null}var fe=Object.assign,Ee=0,be,ke,Ye,Qe,g,S,D;function z(){}z.__reactDisabledLog=!0;function _(){{if(Ee===0){be=console.log,ke=console.info,Ye=console.warn,Qe=console.error,g=console.group,S=console.groupCollapsed,D=console.groupEnd;var l={configurable:!0,enumerable:!0,value:z,writable:!0};Object.defineProperties(console,{info:l,log:l,warn:l,error:l,group:l,groupCollapsed:l,groupEnd:l})}Ee++}}function U(){{if(Ee--,Ee===0){var l={configurable:!0,enumerable:!0,writable:!0};Object.defineProperties(console,{log:fe({},l,{value:be}),info:fe({},l,{value:ke}),warn:fe({},l,{value:Ye}),error:fe({},l,{value:Qe}),group:fe({},l,{value:g}),groupCollapsed:fe({},l,{value:S}),groupEnd:fe({},l,{value:D})})}Ee<0&&I("disabledDepth fell below zero. This is a bug in React. Please file an issue.")}}var L=F.ReactCurrentDispatcher,j;function W(l,h,x){{if(j===void 0)try{throw Error()}catch(Z){var R=Z.stack.trim().match(/\n( *(at )?)/);j=R&&R[1]||""}return`
`+j+l}}var X=!1,Y;{var se=typeof WeakMap=="function"?WeakMap:Map;Y=new se}function k(l,h){if(!l||X)return"";{var x=Y.get(l);if(x!==void 0)return x}var R;X=!0;var Z=Error.prepareStackTrace;Error.prepareStackTrace=void 0;var Q;Q=L.current,L.current=null,_();try{if(h){var q=function(){throw Error()};if(Object.defineProperty(q.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(q,[])}catch(Oe){R=Oe}Reflect.construct(l,[],q)}else{try{q.call()}catch(Oe){R=Oe}l.call(q.prototype)}}else{try{throw Error()}catch(Oe){R=Oe}l()}}catch(Oe){if(Oe&&R&&typeof Oe.stack=="string"){for(var H=Oe.stack.split(`
`),ce=R.stack.split(`
...
`+H[re].replace(" at new "," at ");return l.displayName&&ge.includes("<anonymous>")&&(ge=ge.replace("<anonymous>",l.displayName)),typeof l=="function"&&Y.set(l,ge),ge}while(re>=1&&ae>=0);break}}}finally{X=!1,L.current=Q,U(),Error.prepareStackTrace=Z}var tn=l?l.displayName||l.name:"",ni=tn?W(tn):"";return typeof l=="function"&&Y.set(l,ni),ni}function he(l,h,x){return k(l,!1)}function en(l){var h=l.prototype;return!!(h&&h.isReactComponent)}function He(l,h,x){if(l==null)return"";if(typeof l=="function")return k(l,en(l));if(typeof l=="string")return W(l);switch(l){case d:return W("Suspense");case f:return W("SuspenseList")}if(typeof l=="object")switch(l.$$typeof){case c:return he(l.render);case p:return He(l.type,h,x);case b:{var R=l,Z=R._payload,Q=R._init;try{return He(Q(Z),h,x)}catch{}}}return""}var Un=Object.prototype.hasOwnProperty,Ya={},Ha=F.ReactDebugCurrentFrame;function qn(l){if(l){var h=l._owner,x=He(l.type,l._source,h?h.type:null);Ha.setExtraStackFrame(x)}else Ha.setExtraStackFrame(null)}function du(l,h,x,R,Z){{var Q=Function.call.bind(Un);for(var q in l)if(Q(l,q)){var H=void 0;try{if(typeof l[q]!="function"){var ce=Error((R||"React class")+": "+x+" type `"+q+"` is invalid; it must be a function, usually from the `prop-types` package, but received `"+typeof l[q]+"`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");throw ce.name="Invariant Violation",ce}H=l[q](h,q,R,x,null,"SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED")}catch(re){H=re}H&&!(H instanceof Error)&&(qn(Z),I("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).",R||"React class",x,q,typeof H),qn(null)),H instanceof Error&&!(H.message in Ya)&&(Ya[H.message]=!0,qn(Z),I("Failed %s type: %s",x,H.message),qn(null))}}}var mu=Array.isArray;function Kt(l){return mu(l)}function pu(l){{var h=typeof Symbol=="function"&&Symbol.toStringTag,x=h&&l[Symbol.toStringTag]||l.constructor.name||"Object";return x}}function bu(l){try{return Ga(l),!1}catch{return!0}}function Ga(l){return""+l}function Ua(l){if(bu(l))return I("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.",pu(l)),Ga(l)}var yn=F.ReactCurrentOwner,hu={key:!0,ref:!0,__self:!0,__source:!0},qa,Xa,Jt;Jt={};function gu(l){if(Un.call(l,"ref")){var h=Object.getOwnPropertyDescriptor(l,"ref").get;if(h&&h.isReactWarning)return!1}return l.ref!==void 0}function vu(l){if(Un.call(l,"key")){var h=Object.getOwnPropertyDescriptor(l,"key").get;if(h&&h.isReactWarning)return!1}return l.key!==void 0}function yu(l,h){if(typeof l.ref=="string"&&yn.current&&h&&yn.current.stateNode!==h){var x=pe(yn.current.type);Jt[x]||(I('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref',pe(yn.current.type),l.ref),Jt[x]=!0)}}function wu(l,h){{var x=function(){qa||(qa=!0,I("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",h))};x.isReactWarning=!0,Object.defineProperty(l,"key",{get:x,configurable:!0})}}function xu(l,h){{var x=function(){Xa||(Xa=!0,I("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",h))};x.isReactWarning=!0,Object.defineProperty(l,"ref",{get:x,configurable:!0})}}var ku=function(l,h,x,R,Z,Q,q){var H={$$typeof:n,type:l,key:h,ref:x,props:q,_owner:Q};return H._store={},Object.defineProperty(H._store,"validated",{configurable:!1,enumerable:!1,writable:!0,value:!1}),Object.defineProperty(H,"_self",{configurable:!1,enumerable:!1,writable:!1,value:R}),Object.defineProperty(H,"_source",{configurable:!1,enumerable:!1,writable:!1,value:Z}),Object.freeze&&(Object.freeze(H.props),Object.freeze(H)),H};function $u(l,h,x,R,Z){{var Q,q={},H=null,ce=null;x!==void 0&&(Ua(x),H=""+x),vu(h)&&(Ua(h.key),H=""+h.key),gu(h)&&(ce=h.ref,yu(h,Z));for(Q in h)Un.call(h,Q)&&!hu.hasOwnProperty(Q)&&(q[Q]=h[Q]);if(l&&l.defaultProps){var re=l.defaultProps;for(Q in re)q[Q]===void 0&&(q[Q]=re[Q])}if(H||ce){var ae=typeof l=="function"?l.displayName||l.name||"Unknown":l;H&&wu(q,ae),ce&&xu(q,ae)}return ku(l,H,ce,Z,R,yn.current,q)}}var Vt=F.ReactCurrentOwner,Za=F.ReactDebugCurrentFrame;function nn(l){if(l){var h=l._owner,x=He(l.type,l._source,h?h.type:null);Za.setExtraStackFrame(x)}else Za.setExtraStackFrame(null)}var Qt;Qt=!1;function er(l){return typeof l=="object"&&l!==null&&l.$$typeof===n}function Ka(){{if(Vt.current){var l=pe(Vt.current.type);if(l)return`

Check the render method of \``+l+"`."}return""}}function Cu(l){{if(l!==void 0){var h=l.fileName.replace(/^.*[\\\/]/,""),x=l.lineNumber;return`

Check your code at `+h+":"+x+"."}return""}}var Ja={};function Su(l){{var h=Ka();if(!h){var x=typeof l=="string"?l:l.displayName||l.name;x&&(h=`

Check the top-level render call using <`+x+">.")}return h}}function Va(l,h){{if(!l._store||l._store.validated||l.key!=null)return;l._store.validated=!0;var x=Su(h);if(Ja[x])return;Ja[x]=!0;var R="";l&&l._owner&&l._owner!==Vt.current&&(R=" It was passed a child from "+pe(l._owner.type)+"."),nn(l),I('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.',x,R),nn(null)}}function Qa(l,h){{if(typeof l!="object")return;if(Kt(l))for(var x=0;x<l.length;x++){var R=l[x];er(R)&&Va(R,h)}else if(er(l))l._store&&(l._store.validated=!0);else if(l){var Z=A(l);if(typeof Z=="function"&&Z!==l.entries)for(var Q=Z.call(l),q;!(q=Q.next()).done;)er(q.value)&&Va(q.value,h)}}}function Tu(l){{var h=l.type;if(h==null||typeof h=="string")return;var x;if(typeof h=="function")x=h.propTypes;else if(typeof h=="object"&&(h.$$typeof===c||h.$$typeof===p))x=h.propTypes;else return;if(x){var R=pe(h);du(x,l.props,"prop",R,l)}else if(h.PropTypes!==void 0&&!Qt){Qt=!0;var Z=pe(h);I("Component %s declared `PropTypes` instead of `propTypes`. Did you misspell the property assignment?",Z||"Unknown")}typeof h.getDefaultProps=="function"&&!h.getDefaultProps.isReactClassApproved&&I("getDefaultProps is only used on classic React.createClass definitions. Use a static property named `defaultProps` instead.")}}function Pu(l){{for(var h=Object.keys(l.props),x=0;x<h.length;x++){var R=h[x];if(R!=="children"&&R!=="key"){nn(l),I("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.",R),nn(null);break}}l.ref!==null&&(nn(l),I("Invalid attribute `ref` supplied to `React.Fragment`."),nn(null))}}function ei(l,h,x,R,Z,Q){{var q=We(l);if(!q){var H="";(l===void 0||typeof l=="object"&&l!==null&&Object.keys(l).length===0)&&(H+=" You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports.");var ce=Cu(Z);ce?H+=ce:H+=Ka();var re;l===null?re="null":Kt(l)?re="array":l!==void 0&&l.$$typeof===n?(re="<"+(pe(l.type)||"Unknown")+" />",H=" Did you accidentally export a JSX literal instead of a component?"):re=typeof l,I("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s",re,H)}var ae=$u(l,h,x,Z,Q);if(ae==null)return ae;if(q){var ge=h.children;if(ge!==void 0)if(R)if(Kt(ge)){for(var tn=0;tn<ge.length;tn++)Qa(ge[tn],l);Object.freeze&&Object.freeze(ge)}else I("React.jsx: Static children should always be an array. You are likely explicitly calling React.jsxs or React.jsxDEV. Use the Babel transform instead.");else Qa(ge,l)}return l===r?Pu(ae):Tu(ae),ae}}function Eu(l,h,x){return ei(l,h,x,!0)}function Ou(l,h,x){return ei(l,h,x,!1)}var Au=Ou,Ru=Eu;an.Fragment=r,an.jsx=Au,an.jsxs=Ru}()),an}process.env.NODE_ENV==="production"?Xn.exports=ri():Xn.exports=ai();var Zn=Xn.exports;const rr=Zn.Fragment,u=Zn.jsx,N=Zn.jsxs,ii=m.div`
    position: fixed;
    top: 0;
    left: 0;
    right: 0;
...
`;function Ss({inline:e=!1,display:n=!1,nested:t,children:r}){return u(Cs,{inline:e,nested:t,display:n,children:r})}function Ts({children:e,submitButton:n,onSubmit:t,forwardRef:r=null,...a}){return N($s,{ref:r,onSubmit:t,...a,children:[e,n]})}const Ps=m.label`
    display: block;
    font-size: 1.2rem;
    font-family: ${e=>e.theme.main.font};
...
`,Es=m.span`
    display: inline-block;
    margin-left: 0.3rem;
`,$n=({children:e,required:n=!1})=>{let t=()=>null;return n&&(t=u(Es,{children:"*"})),N(Ps,{children:[e,u(t,{})]})},Os=m.css`
    //margin-bottom:5px;
    //font-size: 0.9rem;
...
`,js=m.div`
    font-size: 1.4rem;
`,Fs=({id:e,name:n,inputBackground:t=null,background:r=!1,inputColour:a=null,inputBorder:i=null,prepend:o=null,append:s=null,label:c=null,type:d="text",caption:f=null,required:p=!1,placeholder:b=!1,defaultValue:$=null,status:O=null,...E})=>{let A={inputBackground:"white",inputColour:"black",inputBorder:ue.main.border};return r&&(A={inputBackground:ue.form.input.background,inputColour:ue.form.input.color,inputBorder:ue.main.border}),t!==null&&(A={...A,inputBackground:t}),a!==null&&(A={...A,inputColour:a}),i!==null&&(A={...A,inputBorder:i}),N(Cn,{htmlFor:n,block:!0,children:[c!==null?u($n,{required:p,children:c}):null,N(As,{...E,...A,children:[o?u(Ls,{children:o}):null,u(Rs,{type:d,name:n,required:p,placeholder:b,defaultValue:$,id:e,...A,...E}),s?u(js,{children:s}):null]}),u(_s,{...A,children:f})]})},Ms=m.div`
    display: flex;
    flex-direction: column;
    width: 100%;
`,zs=m.select`
...
`,kr=({value:e,name:n,children:t,label:r,inline:a=!1,onChange:i=()=>{}})=>N(Ms,{children:[r?u($n,{htmlFor:n,children:r}):null,u(Ds,{inline:a,children:u(zs,{value:e,name:n,onChange:i,inline:!0,children:t})})]}),Ns=m.div`
    flex-direction: row;
...
`,ot=({name:e,id:n,label:t=null,required:r,checked:a,value:i,inline:o=!1,disabled:s=!1,className:c=null,backgroundColor:d=null,color:f=null,margin:p=null,...b})=>u(Ns,{inline:o,className:c,margin:p,children:N(Bs,{htmlFor:n,disabled:s,children:[u(Ws,{type:"checkbox",name:e,id:n,required:r,value:i,checked:a,disabled:s,backgroundColor:d,color:f,...b}),t]})}),Ys=m.div`
    flex-direction: row;
    display: ${e=>e.inline?"inline-flex":"flex"};
    margin: ${e=>e.margin?e.margin:"0 2rem 0.8rem 0"};
    align-items: center;
...
`,Us=({name:e,label:n="",required:t,checked:r,inline:a=!1,disabled:i=!1,value:o,margin:s=null,backgroundColor:c=null,color:d=null,className:f="",defaultChecked:p=!1,id:b=!1,...$})=>u(Ys,{inline:a,className:f,margin:s,children:N(Hs,{htmlFor:b,disabled:i,children:[u(Gs,{type:"radio",checked:r,disabled:i,value:o,name:e,id:b||e,required:t,defaultChecked:r,backgroundColor:c,color:d,margin:n!=="",...$}),n]})}),qs=m.div`
    width: 100%;
`,Xs=m.div`
    display: flex;
    flex-direction: row;
...
`,$r=m(kr)``,Zs=m.div`
    margin: 0 0.5rem;
    color: ${({theme:e})=>e.main.color};
`;function Ks({label:e,name:n,hourMin:t=0,hourMax:r=23,hourValue:a,minuteMin:i=0,minuteMax:o=59,minuteValue:s}){const[c,d]=K.useState(a),[f,p]=K.useState(s);K.useEffect(()=>{d(a),p(s)},[a,s]);function b(){const O=[];for(let E=t;E<=r;E++)O.push(E<10?`0${E}`:E);return O}function $(){const O=[];for(let E=i;E<=o;E++)O.push(E<10?`0${E}`:E);return O}return N(qs,{children:[u($n,{children:e}),N(Xs,{children:[u($r,{value:c,name:`${n}[hour]`,inline:!0,onChange:O=>d(O.target.value),children:b().map(O=>u("option",{value:O,children:O},`${n}-${O}`))},`${n}-hour`),u(Zs,{children:":"}),u($r,{value:f,name:`${n}[minute]`,inline:!0,onChange:O=>p(O.target.value),children:$().map(O=>u("option",{value:O,children:O},`${n}-${O}`))},`${n}-minute`)]})]})}const Js=m.textarea`
    width: 100%;
    height: 10rem;
    padding: 0.5rem;
    margin: 0 0 1rem;
...
`,sf=m(Fe)`
    color: ${e=>e.theme.main.color};
    font-weight: normal;
`;function lf({name:e,index:n,checked:t,setChecked:r,value:a,label:i,icon:o}){const s=e+n;return u(nf,{children:N(tf,{checked:t,htmlFor:s,children:[u(rf,{checked:t,children:u(Be,{icon:ef})}),u(af,{id:s,name:e,value:a,checked:t,onChange:c=>r(c.target.value)}),N(of,{children:[u(Be,{icon:o}),u(sf,{children:i})]})]})})}const cf=m.div`
    font-family: ${e=>e.theme.main.font};
...
`,uf=m.span`
    font-size: 1.1em;
    margin-left: 0.75rem;
`,df=({name:e,id:n,checked:t,value:r,label:a,className:i=null,...o})=>{const s={...o};return console.log("switch attributes",s),u(cf,{className:i,...s,children:N(ff,{htmlFor:e,...s,children:[N("div",{className:"switch",children:[u("input",{id:n,name:e,value:r,checked:t,type:"checkbox",...s}),u("span",{className:"slider round",...s})]}),u(uf,{className:"spanLabel",children:a})]})})},Gn=m.css`
    color: ${ue.main.color};
    font-family: ${e=>e.theme.main.font};
    margin: 0;
...
`,hf=m.h4`
    ${Gn}
    font-size: 1.2rem;
`,za=({type:e="heading",children:n,...t})=>{switch(e.toLowerCase()){case"hero":return u(mf,{...t,children:n});case"title":return u(pf,{...t,children:n});case"subtitle":return u(bf,{...t,children:n});default:return u(hf,{...t,children:n})}},gf=m.hr`
    width: ${({width:e})=>e};
    margin: 0 auto;
    border-bottom: 1px solid ${({color:e})=>e!==null?e:ue.generalColors.midGrey};
`,vf=({width:e="100%",color:n=null})=>u(gf,{width:e,color:n}),yf=m.a`
    display: inline-block;
...
`,$f=({checked:e=!1,children:n,...t})=>u(kf,{className:e?"active":"",...t,children:n}),Cf=m.div``,Sf=m.div`
...
`,Tf=({children:e,...n})=>u(Cf,{...n,children:u(Sf,{children:e})}),Pf=m.div`
    display: block;
    position: relative;
`,Ef=({children:e,...n})=>u(Pf,{...n,children:e}),Of=m.div`
    display: flex;
    justify-content: center;
...
`;function Na({icon:e,title:n="",component:t=null,className:r,...a}){return N(Of,{className:r,...a,children:[u(Af,{icon:e,color:ue.form.input.border}),u(Rf,{type:"heading",children:n}),t]})}const If=m(Na)`
...
`;function _f({icon:e,title:n="",component:t=null,dropHandler:r=()=>{}}){const[a,i]=K.useState(!1);return u(If,{icon:e,title:n,component:t,over:a,dropHandler:r,onDragOver:d=>{d.preventDefault(),i(!0)},onDragLeave:d=>{d.preventDefault(),i(!1)},onDrop:d=>{d.preventDefault(),i(!1);const f=d.dataTransfer.files[0];r(f)}})}const Lf=m.div`
...
`;function Mf({data:e,rowPadding:n=null}){const{headings:t}=e,{rows:r}=e;return u(Lf,{children:N(jf,{children:[N(qt,{border:!0,rowPadding:n,className:"tableHeader",children:[u(Xt,{children:u(ot,{margin:"0px"})}),t.map(a=>u(Xt,{columns:t.length,children:u(Fe,{fontWeight:"bold",children:a})},a))]}),r.map((a,i)=>N(qt,{rowPadding:n,children:[u(Zt,{className:"rowCheckbox",children:u(ot,{margin:"0px"})}),Object.keys(a).map((o,s)=>u(Zt,{border:!0,justify:o==="actions"?"flex-end":"flex-start",className:o==="actions"?"actions":null,columns:t.length,children:o!=="actions"?u(Ff,{children:a[o]}):a[o]},`${o}-${i}-${s}`))]},`${a.name}-${i}`))]})})}const zf=m.div`
    color: ${e=>e.theme.main.color};
...
`;function Hf({content:e=null,onClose:n=()=>{},onOpen:t=()=>{},isOpen:r=!1,transparent:a=!1,className:i=null,wide:o=!1}){return K.useEffect(()=>(t(),()=>{n()}),[n,t]),r?N(Bf,{children:[u(Wf,{onClick:()=>n(null)}),u(Yf,{id:"mainModal",transparent:a,wide:o,children:e})]}):null}const Gf=m.ul`
    overflow-y: auto;
    max-height: 50vh;
...
`;function Wa({padding:e=null,margin:n,children:t,background:r}){return u(Gf,{padding:e,margin:n,background:r,children:t})}const Uf=m.div`
    padding: 1rem;
...
`,Zf=m.div`
    ...
    border-bottom: ${e=>e.border?`1px solid ${e.theme.main.border}`:"none"};
    margin-left: auto;
`;function Kf({horizontal:e,margin:n,border:t=!0,children:r}){return u(Uf,{horizontal:e,margin:n,border:t,children:r})}const Jf=m(Wa)`
    & .placeholder {
...
`,eu=m.div`
    cursor: grab;
`;function nu({children:e,...n}){const[t,r]=K.useState(K.Children.toArray(e)),a=K.useRef(),i=K.useRef();K.useEffect(()=>{r(K.Children.toArray(e))},[e]);const o=f=>{a.current=f},s=f=>{i.current=f},c=f=>{f.preventDefault();const p=i.current;if(p===void 0)return;const b=[...t],$=b[a.current];b.splice(a.current,1),b.splice(p,0,$),a.current=p,r(b)},d=()=>{a.current=null,i.current=null};return u(Jf,{...n,children:t.map((f,p)=>u(eu,{draggable:!0,onDragStart:()=>o(p),onDragEnter:()=>s(p),onDragOver:c,onDrop:d,children:f},p))})}const tu=m.circle`
    fill: none;
...
`,au=m.svg`
    ...
    margin: 10px;
    max-width: 100%;
`,iu=({progress:e,max:n=100,size:t,strokeWidth:r=10})=>{const a=(t-10)/2,i=a*2*Math.PI,o=i-e/n*i;return N(au,{width:t,height:t,children:[u(tu,{strokeWidth:r,r:a,cx:t/2,cy:t/2}),u(ru,{strokeWidth:r,r:a,cx:t/2,cy:t/2,dashArray:i,dashOffset:o})]})},ou=m.div``,su=m.div`
    display: flex;
    align-items: center;
    margin-bottom: 1rem;
...
`,cu=m.div``,fu=m.div``;function uu({children:e,position:n=0,handleNext:t,handleBack:r,handleEnd:a,endText:i="Submit"}){let o=n;return n<0?o=0:n>K.Children.count(e)-1&&(o=K.Children.count(e)-1),N(ou,{children:[N(su,{children:[u(iu,{progress:o+1,max:K.Children.count(e),size:50,strokeWidth:8}),N(cu,{children:[N(Fe,{children:["Step ",o+1," of ",K.Children.count(e)]}),K.Children.map(e,(s,c)=>c===o?u(za,{children:s.props.title}):null)]})]}),K.Children.map(e,(s,c)=>c===o?s:null),N(lu,{children:[u(ve,{onClick:r,disabled:o===0,neutral:!0,children:"Previous"}),o===K.Children.count(e)-1?u(ve,{onClick:a,children:i}):u(ve,{onClick:t,disabled:o===K.Children.count(e)-1,children:"Next Step"})]})]})}y.ActionPanel=Na,y.Background=li,y.Button=ve,y.Card=Kf,y.CardBody=Xf,y.CardFooter=Zf,y.CardHeader=qf,y.Checkbox=ot,y.Chip=Ji,y.ColorPicker=Qi,y.Column=So,y.ColumnContainer=go,y.ColumnWrapper=Co,y.Container=xo,y.ContainerContent=wo,y.Content=ho,y.DragDropList=nu,y.DraggableListItem=Vf,y.DraggableListItemHandle=Qf,y.DroppableActionPanel=_f,y.FlexTable=ms,y.FlexTableCell=gs,y.FlexTableHead=ks,y.FlexTableHeader=ws,y.FlexTableRow=bs,y.Form=Ts,y.FormRow=Ss,y.GridContainer=vo,y.Header=bo,y.Heading=za,y.Hr=vf,y.IconBoxes=is,y.Input=Fs,y.Label=$n,y.ListItem=Ba,y.Modal=Hf,y.ModalBody=Df,y.ModalFooter=Nf,y.ModalHeader=zf,y.Pod=mo,y.PositionContainer=po,y.Radio=Us,y.RadioPanel=lf,y.Rectangle=us,y.ResponseBox=jo,y.ResponsiveTable=Mf,y.ScrollableList=Wa,y.Select=kr,y.Step=fu,y.Steps=uu,y.Switch=df,y.Tab=wf,y.TabContent=Ef,y.TabGroup=Tf,y.TabPane=$f,y.TabWrap=xf,y.Table=qo,y.TableCell=Zt,y.TableHeading=Xt,y.TableRow=qt,y.Td=Qo,y.Text=Fe,y.TextArea=Vs,y.TextPairs=wr,y.Th=Jo,y.TimeSelect=Ks,y.ToggleArea=pr,y.Tr=Zo,y.extendDefaultTheme=ue,Object.defineProperty(y,Symbol.toStringTag,{value:"Module"})});
