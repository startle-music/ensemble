...
`,li=m.svg`
    ...
    margin: 10px;
    max-width: 100%;
`,ar=({progress:e,max:n=100,size:t,strokeWidth:r=10})=>{const a=(t-10)/2,i=a*2*Math.PI,o=i-e/n*i;return F(li,{width:t,height:t,children:[d(oi,{strokeWidth:r,r:a,cx:t/2,cy:t/2}),d(si,{strokeWidth:r,r:a,cx:t/2,cy:t/2,dashArray:i,dashOffset:o})]})},ci=m.div`
    position: fixed;
    top: 0;
    left: 0;
    right: 0;
...
`;m.input`
    ${Vn}
`;const yi=e=>{const{children:n,to:t}=e;return d(ir,{href:t,...e,children:n})},wi=e=>{const{children:n,href:t}=e;return d(ir,{href:t,...e,children:n})};m.div`
    position: relative;
    user-select: none;
...
`;function hr({check:e,value:n,passThrough:t,children:r}){return e===n?d(Eo,{passthrough:t,children:r}):null}const Po=m.div`
    //grid-row: 1;
...
`,Yo=20,Ho=5;class Go extends G.Component{constructor(n){super(n),this.renderPageButton=this.renderPageButton.bind(this)}renderMore(){const{page:n,paginate:t}=this.props;return d(gr,{children:d(fe,{onClick:(a=>{t(a)})(n),children:"Load More"})})}renderPageButton(n){const{paginate:t,page:r}=this.props,a=o=>{t(o)};let i="";return r===n||r<=0&&n===1?i="active":i="number",d(fe,{value:"Test Button",type:"button",outline:"true",className:i,onClick:()=>{a(n)},children:n},`pagination-page-${n}`)}renderBackPageButton(n){const{paginate:t,page:r}=this.props,a=c=>{t(c)};let i="",o="",s=!1;return r>1&&n.pages.length>0?(i="arrow",o="#e83948"):(i="inactivearrow",o="#B4B7BC",s=!0),d(fe,{disabled:s,className:i,onClick:()=>{a(r-1)},children:d(vr,{color:o,children:d(Wo,{})})})}renderNextPageButton(n){const{paginate:t,page:r}=this.props,a=s=>{t(s)};let i="",o="";return r<n.totalPages?(i="arrow",o="#e83948"):(i="inactivearrow",o="#B4B7BC"),d(fe,{className:i,onClick:()=>{a(r+1)},children:d(vr,{color:o,children:d(Bo,{})})})}renderPages(){const{page:n,totalRecords:t}=this.props,r=No(t,n,Yo,Ho),{pages:a}=r;return d(gr,{children:a&&a.length>1?F(rr,{children:[this.renderBackPageButton(r),a.map(this.renderPageButton),this.renderNextPageButton(r)]}):null})}render(){const{type:n}=this.props;switch(n){case"paginate":return this.renderPages(n);case"more":return this.renderMore(n);case"none":default:return null}}}const Uo=(e,n,t)=>{let r;return function(...a){const i=this,o=function(){r=null,t||e.apply(i,a)},s=t&&!r;clearTimeout(r),r=setTimeout(o,n),s&&e.apply(i,a)}},yr=m.css`
    padding: 10px 15px;
...
`,os=m(wr)`
    ...
    min-width:2rem;
    color: '#333333';
`,xr=({fill:e,leftText:n="",rightText:t="",Icon:r})=>F(as,{children:[d(is,{fill:e,children:n}),d(os,{children:t})]}),ss=m.div`
    display:flex;
    width:100%;
...
`,ls=m.div`
    ...
    margin-right:.5rem;
    color: ${e=>e.fill};
`,cs=({fill:e,leftText:n="",rightText:t="",Icon:r})=>F(ss,{children:[d(ls,{fill:e,children:d(r,{fill:e})}),d(xr,{fill:e,leftText:n,rightText:t})]}),it=m.css`
...
`,ds=m.p`
    ${it}
    font-size: 1rem;
`,Me=({type:e="heading",children:n,...t})=>{switch(e.toLowerCase()){case"help":return d(fs,{...t,children:n});case"small":return d(us,{...t,children:n});default:return d(ds,{...t,children:n})}},ms=m.div`
    padding:.75rem;
    border-radius:10px;
    background-color:#fff;
`,ps=m.div`
    margin-top:.25rem;
`,hs=({text:e="",children:n,...t})=>F(ms,{...t,children:[d(Me,{type:"small",children:e}),d(ps,{children:n})]}),bs=m.div`
    display: block;
...
`,xs=({children:e,...n})=>d(ws,{...n,children:e}),kr=m.div`
    padding: 0.6rem 0.4rem;
`,ks=m.css`
    //color: ${e=>e.theme.main.color};
    //font-family: ${e=>e.theme.main.font};
...
`,$s=m.h4`
    ...
    font-size: 0.95rem;
    //color: ${e=>e.theme.main.color};
`,Cs=({type:e,children:n})=>{switch(e){case"smalltableheader":return d(kr,{children:d($s,{children:n})});default:return d(kr,{children:n})}},Ss=m.div`
    display: flex;
    flex-wrap: nowrap;
    border-bottom: 1px solid ${e=>e.theme.main.color};
...
`,$r=({value:e,name:n,children:t,label:r,inline:a=!1,onChange:i=()=>{}})=>F(Bs,{children:[r?d($n,{htmlFor:n,children:r}):null,d(Ys,{inline:a,children:d(Ws,{value:e,name:n,onChange:i,inline:!0,children:t})})]}),Hs=m.div`
    flex-direction: row;
    //display: ${e=>e.inline?"inline-flex":"flex"};
...
`,Cr=m($r)``,Qs=m.div`
    margin: 0 0.5rem;
    color: ${({theme:e})=>e.main.color};
`;function el({label:e,name:n,hourMin:t=0,hourMax:r=23,hourValue:a,minuteMin:i=0,minuteMax:o=59,minuteValue:s}){const[c,f]=G.useState(a),[u,p]=G.useState(s);G.useEffect(()=>{f(a),p(s)},[a,s]);function h(){const E=[];for(let O=t;O<=r;O++)E.push(O<10?`0${O}`:O);return E}function y(){const E=[];for(let O=i;O<=o;O++)E.push(O<10?`0${O}`:O);return E}return F(Ks,{children:[d($n,{children:e}),F(Js,{children:[d(Cr,{value:c,name:`${n}[hour]`,inline:!0,onChange:E=>f(E.target.value),children:h().map(E=>d("option",{value:E,children:E},`${n}-${E}`))},`${n}-hour`),d(Qs,{children:":"}),d(Cr,{value:u,name:`${n}[minute]`,inline:!0,onChange:E=>p(E.target.value),children:y().map(E=>d("option",{value:E,children:E},`${n}-${E}`))},`${n}-minute`)]})]})}const nl=m.textarea`
    width: 100%;
    height: 10rem;
    padding: 0.5rem;
    margin: 0 0 1rem;
...
`,If=m.h4`
    ${Gn}
    font-size: 1.2rem;
`,Da=({type:e="heading",children:n,...t})=>{switch(e.toLowerCase()){case"hero":return d(Of,{...t,children:n});case"title":return d(Af,{...t,children:n});case"subtitle":return d(Rf,{...t,children:n});default:return d(If,{...t,children:n})}},_f=m.hr`
    width: ${({width:e})=>e};
    margin: 0 auto;
...
`;function Ba({icon:e,title:n="",component:t=null,className:r,...a}){return F(Gf,{className:r,...a,children:[d(Uf,{icon:e,color:de.form.input.border}),d(qf,{type:"heading",children:n}),t]})}const Xf=m(Ba)`
