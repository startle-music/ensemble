...
`,Zc=m.div`
    font-size: 1.4rem;
`,Kc=({id:e,name:t,inputBackground:n=null,background:r=!1,inputColour:a=null,inputBorder:i=null,prepend:o=null,append:s=null,label:c=null,type:u="text",caption:f=null,required:p=!1,placeholder:h=!1,defaultValue:g=null,status:P=null,...k})=>{let S={inputBackground:"white",inputColour:"black",inputBorder:ye.main.border};return r&&(S={inputBackground:ye.form.input.background,inputColour:ye.form.input.color,inputBorder:ye.main.border}),n!==null&&(S={...S,inputBackground:n}),a!==null&&(S={...S,inputColour:a}),i!==null&&(S={...S,inputBorder:i}),z(Yt,{htmlFor:t,block:!0,children:[c!==null?d(Wt,{required:p,children:c}):null,z(Gc,{...k,...S,children:[o?d(Vc,{children:o}):null,d(Uc,{type:u,name:t,required:p,placeholder:h,defaultValue:g,id:e,...S,...k}),s?d(Zc,{children:s}):null]}),d(Xc,{...S,children:f})]})},Jc=m.div`
    display: flex;
    flex-direction: column;
    width: 100%;
`,Qc=m.select`
...
`,Ya=m(Wa)``,uf=m.div`
    margin: 0 0.5rem;
    color: ${({theme:e})=>e.main.color};
`;function df({label:e,name:t,hourMin:n=0,hourMax:r=23,hourValue:a,minuteMin:i=0,minuteMax:o=59,minuteValue:s,onChange:c=()=>{}}){const[u,f]=I.useState(a),[p,h]=I.useState(s);I.useEffect(()=>{f(a),h(s)},[a,s]);function g(){const k=[];for(let S=n;S<=r;S++)k.push(S<10?`0${S}`:S);return k}function P(){const k=[];for(let S=i;S<=o;S++)k.push(S<10?`0${S}`:S);return k}return z(cf,{children:[d(Wt,{children:e}),z(ff,{children:[d(Ya,{value:u,name:`${t}[hour]`,inline:!0,onChange:k=>{c(k),f(k.target.value)},children:g().map(k=>d("option",{value:k,children:k},`${t}-${k}`))},`${t}-hour`),d(uf,{children:":"}),d(Ya,{value:p,name:`${t}[minute]`,inline:!0,onChange:k=>{c(k),h(k.target.value)},children:P().map(k=>d("option",{value:k,children:k},`${t}-${k}`))},`${t}-minute`)]})]})}const mf=m.textarea`
    width: 100%;
    height: 10rem;
    padding: 0.5rem;
    margin: 0 0 1rem;
