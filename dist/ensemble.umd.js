...
`+H[re].replace(" at new "," at ");return l.displayName&&ve.includes("<anonymous>")&&(ve=ve.replace("<anonymous>",l.displayName)),typeof l=="function"&&Y.set(l,ve),ve}while(re>=1&&ae>=0);break}}}finally{V=!1,j.current=Q,U(),Error.prepareStackTrace=Z}var tn=l?l.displayName||l.name:"",ii=tn?W(tn):"";return typeof l=="function"&&Y.set(l,ii),ii}function ge(l,b,k){return $(l,!1)}function en(l){var b=l.prototype;return!!(b&&b.isReactComponent)}function Ye(l,b,k){if(l==null)return"";if(typeof l=="function")return $(l,en(l));if(typeof l=="string")return W(l);switch(l){case u:return W("Suspense");case f:return W("SuspenseList")}if(typeof l=="object")switch(l.$$typeof){case c:return ge(l.render);case p:return Ye(l.type,b,k);case h:{var R=l,Z=R._payload,Q=R._init;try{return Ye(Q(Z),b,k)}catch{}}}return""}var qn=Object.prototype.hasOwnProperty,qa={},Xa=z.ReactDebugCurrentFrame;function Xn(l){if(l){var b=l._owner,k=Ye(l.type,l._source,b?b.type:null);Xa.setExtraStackFrame(k)}else Xa.setExtraStackFrame(null)}function Iu(l,b,k,R,Z){{var Q=Function.call.bind(qn);for(var q in l)if(Q(l,q)){var H=void 0;try{if(typeof l[q]!="function"){var ce=Error((R||"React class")+": "+k+" type `"+q+"` is invalid; it must be a function, usually from the `prop-types` package, but received `"+typeof l[q]+"`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");throw ce.name="Invariant Violation",ce}H=l[q](b,q,R,k,null,"SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED")}catch(re){H=re}H&&!(H instanceof Error)&&(Xn(Z),I("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).",R||"React class",k,q,typeof H),Xn(null)),H instanceof Error&&!(H.message in qa)&&(qa[H.message]=!0,Xn(Z),I("Failed %s type: %s",k,H.message),Xn(null))}}}var _u=Array.isArray;function Qt(l){return _u(l)}function ju(l){{var b=typeof Symbol=="function"&&Symbol.toStringTag,k=b&&l[Symbol.toStringTag]||l.constructor.name||"Object";return k}}function Lu(l){try{return Va(l),!1}catch{return!0}}function Va(l){return""+l}function Za(l){if(Lu(l))return I("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.",ju(l)),Va(l)}var yn=z.ReactCurrentOwner,Fu={key:!0,ref:!0,__self:!0,__source:!0},Ka,Ja,er;er={};function zu(l){if(qn.call(l,"ref")){var b=Object.getOwnPropertyDescriptor(l,"ref").get;if(b&&b.isReactWarning)return!1}return l.ref!==void 0}function Mu(l){if(qn.call(l,"key")){var b=Object.getOwnPropertyDescriptor(l,"key").get;if(b&&b.isReactWarning)return!1}return l.key!==void 0}function Du(l,b){if(typeof l.ref=="string"&&yn.current&&b&&yn.current.stateNode!==b){var k=he(yn.current.type);er[k]||(I('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref',he(yn.current.type),l.ref),er[k]=!0)}}function Nu(l,b){{var k=function(){Ka||(Ka=!0,I("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",b))};k.isReactWarning=!0,Object.defineProperty(l,"key",{get:k,configurable:!0})}}function Bu(l,b){{var k=function(){Ja||(Ja=!0,I("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",b))};k.isReactWarning=!0,Object.defineProperty(l,"ref",{get:k,configurable:!0})}}var Wu=function(l,b,k,R,Z,Q,q){var H={$$typeof:n,type:l,key:b,ref:k,props:q,_owner:Q};return H._store={},Object.defineProperty(H._store,"validated",{configurable:!1,enumerable:!1,writable:!0,value:!1}),Object.defineProperty(H,"_self",{configurable:!1,enumerable:!1,writable:!1,value:R}),Object.defineProperty(H,"_source",{configurable:!1,enumerable:!1,writable:!1,value:Z}),Object.freeze&&(Object.freeze(H.props),Object.freeze(H)),H};function Yu(l,b,k,R,Z){{var Q,q={},H=null,ce=null;k!==void 0&&(Za(k),H=""+k),Mu(b)&&(Za(b.key),H=""+b.key),zu(b)&&(ce=b.ref,Du(b,Z));for(Q in b)qn.call(b,Q)&&!Fu.hasOwnProperty(Q)&&(q[Q]=b[Q]);if(l&&l.defaultProps){var re=l.defaultProps;for(Q in re)q[Q]===void 0&&(q[Q]=re[Q])}if(H||ce){var ae=typeof l=="function"?l.displayName||l.name||"Unknown":l;H&&Nu(q,ae),ce&&Bu(q,ae)}return Wu(l,H,ce,Z,R,yn.current,q)}}var nr=z.ReactCurrentOwner,Qa=z.ReactDebugCurrentFrame;function nn(l){if(l){var b=l._owner,k=Ye(l.type,l._source,b?b.type:null);Qa.setExtraStackFrame(k)}else Qa.setExtraStackFrame(null)}var tr;tr=!1;function rr(l){return typeof l=="object"&&l!==null&&l.$$typeof===n}function ei(){{if(nr.current){var l=he(nr.current.type);if(l)return`

Check the render method of \``+l+"`."}return""}}function Hu(l){{if(l!==void 0){var b=l.fileName.replace(/^.*[\\\/]/,""),k=l.lineNumber;return`

Check your code at `+b+":"+k+"."}return""}}var ni={};function Gu(l){{var b=ei();if(!b){var k=typeof l=="string"?l:l.displayName||l.name;k&&(b=`

Check the top-level render call using <`+k+">.")}return b}}function ti(l,b){{if(!l._store||l._store.validated||l.key!=null)return;l._store.validated=!0;var k=Gu(b);if(ni[k])return;ni[k]=!0;var R="";l&&l._owner&&l._owner!==nr.current&&(R=" It was passed a child from "+he(l._owner.type)+"."),nn(l),I('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.',k,R),nn(null)}}function ri(l,b){{if(typeof l!="object")return;if(Qt(l))for(var k=0;k<l.length;k++){var R=l[k];rr(R)&&ti(R,b)}else if(rr(l))l._store&&(l._store.validated=!0);else if(l){var Z=A(l);if(typeof Z=="function"&&Z!==l.entries)for(var Q=Z.call(l),q;!(q=Q.next()).done;)rr(q.value)&&ti(q.value,b)}}}function Uu(l){{var b=l.type;if(b==null||typeof b=="string")return;var k;if(typeof b=="function")k=b.propTypes;else if(typeof b=="object"&&(b.$$typeof===c||b.$$typeof===p))k=b.propTypes;else return;if(k){var R=he(b);Iu(k,l.props,"prop",R,l)}else if(b.PropTypes!==void 0&&!tr){tr=!0;var Z=he(b);I("Component %s declared `PropTypes` instead of `propTypes`. Did you misspell the property assignment?",Z||"Unknown")}typeof b.getDefaultProps=="function"&&!b.getDefaultProps.isReactClassApproved&&I("getDefaultProps is only used on classic React.createClass definitions. Use a static property named `defaultProps` instead.")}}function qu(l){{for(var b=Object.keys(l.props),k=0;k<b.length;k++){var R=b[k];if(R!=="children"&&R!=="key"){nn(l),I("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.",R),nn(null);break}}l.ref!==null&&(nn(l),I("Invalid attribute `ref` supplied to `React.Fragment`."),nn(null))}}function ai(l,b,k,R,Z,Q){{var q=Be(l);if(!q){var H="";(l===void 0||typeof l=="object"&&l!==null&&Object.keys(l).length===0)&&(H+=" You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports.");var ce=Hu(Z);ce?H+=ce:H+=ei();var re;l===null?re="null":Qt(l)?re="array":l!==void 0&&l.$$typeof===n?(re="<"+(he(l.type)||"Unknown")+" />",H=" Did you accidentally export a JSX literal instead of a component?"):re=typeof l,I("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s",re,H)}var ae=Yu(l,b,k,Z,Q);if(ae==null)return ae;if(q){var ve=b.children;if(ve!==void 0)if(R)if(Qt(ve)){for(var tn=0;tn<ve.length;tn++)ri(ve[tn],l);Object.freeze&&Object.freeze(ve)}else I("React.jsx: Static children should always be an array. You are likely explicitly calling React.jsxs or React.jsxDEV. Use the Babel transform instead.");else ri(ve,l)}return l===r?qu(ae):Uu(ae),ae}}function Xu(l,b,k){return ai(l,b,k,!0)}function Vu(l,b,k){return ai(l,b,k,!1)}var Zu=Vu,Ku=Xu;an.Fragment=r,an.jsx=Zu,an.jsxs=Ku}()),an}process.env.NODE_ENV==="production"?Vn.exports=si():Vn.exports=li();var Zn=Vn.exports;const or=Zn.Fragment,d=Zn.jsx,F=Zn.jsxs,ci=m.circle`
    fill: none;
...
`,to=m.div`
    ...
    margin: 0;
    padding: 0;
`,ro=(e,n)=>{if(console.log("onRemove",e),e===null)return null;const{label:t,name:r,value:a}=n;return d("button",{type:"button",onClick:e,label:t,name:r,value:a,children:d(gr,{})})},ao=()=>null;function io(e){let n="white";return e!==null&&(n=e),n}function oo({label:e,value:n,name:t=null,color:r="red",textColor:a=null,onClick:i=null,onRemove:o=null}){let s=t;t===null&&(s=`chip-name-${e}`);let c=ao;i!==null&&(c=i);const u=io(a);return d(no,{children:F(vr,{color:r,textColor:u,children:[F("label",{htmlFor:s,onClick:c,children:[d("input",{type:"checkbox",name:s,value:n,defaultChecked:!0}),e]}),ro(o,{label:e,name:t,value:n})]})})}function vr({children:e,color:n="#FF0000",textColour:t=null}){return d(eo,{backgroundColor:n,color:t,children:e})}function so({children:e}){return d(to,{children:e})}const lo=m.div`
    margin-bottom: 1em;
...
`;function yr({check:e,value:n,passThrough:t,children:r}){return e===n?d(Io,{passthrough:t,children:r}):null}const _o=m.div`
    //grid-row: 1;
...
`,gc=m(Ma)`
    ...
    min-width:2rem;
    color: '#333333';
`,Da=({fill:e,leftText:n="",rightText:t="",Icon:r})=>F(hc,{children:[d(bc,{fill:e,children:n}),d(gc,{children:t})]}),vc=m.div`
    display:flex;
    width:100%;
...
`,yc=m.div`
    ...
    margin-right:.5rem;
    color: ${e=>e.fill};
`,wc=({fill:e,leftText:n="",rightText:t="",Icon:r})=>F(vc,{children:[d(yc,{fill:e,children:d(r,{fill:e})}),d(Da,{fill:e,leftText:n,rightText:t})]}),Xt=m.css`
    font-family: ${e=>e.theme.main.font};
...
`,Ic=({children:e,...n})=>d(Rc,{...n,children:e}),Na=m.div`
    padding: 0.6rem 0.4rem;
`,_c=m.css`
    //color: ${e=>e.theme.main.color};
    //font-family: ${e=>e.theme.main.font};
...
`,jc=m.h4`
    ...
    font-size: 0.95rem;
    //color: ${e=>e.theme.main.color};
`,Lc=({type:e,children:n})=>{switch(e){case"smalltableheader":return d(Na,{children:d(jc,{children:n})});default:return d(Na,{children:n})}},Fc=m.div`
    display: flex;
    flex-wrap: nowrap;
    border-bottom: 1px solid ${e=>e.theme.main.color};
...
`,Ba=({value:e,name:n,children:t,label:r,inline:a=!1,onChange:i=()=>{}})=>F(Jc,{children:[r?d(Yn,{htmlFor:n,children:r}):null,d(ef,{inline:a,children:d(Qc,{value:e,name:n,onChange:i,inline:!0,children:t})})]}),nf=m.div`
    flex-direction: row;
    //display: ${e=>e.inline?"inline-flex":"flex"};
...
`,Wa=m(Ba)``,uf=m.div`
    margin: 0 0.5rem;
    color: ${({theme:e})=>e.main.color};
`;function df({label:e,name:n,hourMin:t=0,hourMax:r=23,hourValue:a,minuteMin:i=0,minuteMax:o=59,minuteValue:s}){const[c,u]=X.useState(a),[f,p]=X.useState(s);X.useEffect(()=>{u(a),p(s)},[a,s]);function h(){const P=[];for(let O=t;O<=r;O++)P.push(O<10?`0${O}`:O);return P}function w(){const P=[];for(let O=i;O<=o;O++)P.push(O<10?`0${O}`:O);return P}return F(cf,{children:[d(Yn,{children:e}),F(ff,{children:[d(Wa,{value:c,name:`${n}[hour]`,inline:!0,onChange:P=>u(P.target.value),children:h().map(P=>d("option",{value:P,children:P},`${n}-${P}`))},`${n}-hour`),d(uf,{children:":"}),d(Wa,{value:f,name:`${n}[minute]`,inline:!0,onChange:P=>p(P.target.value),children:w().map(P=>d("option",{value:P,children:P},`${n}-${P}`))},`${n}-minute`)]})]})}const mf=m.textarea`
    width: 100%;
    height: 10rem;
    padding: 0.5rem;
    margin: 0 0 1rem;
...
`;function Ha({icon:e,title:n="",component:t=null,className:r,...a}){return F(Kf,{className:r,...a,children:[d(Jf,{icon:e,color:de.actionPanel.iconColor}),d(Qf,{type:"heading",children:n}),t]})}const eu=m(Ha)`
        @media (min-width: ${e=>e.theme.layout.breakpoints.sm}) {
...
`;function Ua({padding:e=null,margin:n,children:t,background:r}){return d(mu,{padding:e,margin:n,background:r,children:t})}const pu=m.div`
    padding: 1rem;
...
`,gu=m.div`
    ...
    border-bottom: ${e=>e.border?`1px solid ${e.theme.main.border}`:"none"};
    margin-left: auto;
`;function vu({horizontal:e,margin:n,border:t=!0,children:r}){return d(pu,{horizontal:e,margin:n,border:t,children:r})}const yu=m(Ua)`
    & .placeholder {
